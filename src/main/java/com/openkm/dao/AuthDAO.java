...
//			qTwitter.executeUpdate();
	...
	public static List<String> findAllEmails(String user) throws DatabaseException{
		log.debug("findAllEmails({})");
		String qs = "select u.email from User u where  u.id<>:userId";
		Session session = null;
