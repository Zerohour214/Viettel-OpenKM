...
<%
  ...
  Logger log  = Logger.getLogger("INDEXXXXX");
  log.info(request.toString());
//  request.getSession().setAttribute(HttpSessionSecurityContextRepository.SPRING_SECURITY_CONTEXT_KEY, SecurityContextHolder.getContext().getAuthentication());
...
<!DOCTYPE html>
    ...
    <link type="text/css" rel="stylesheet" href="custom_styles.css" title="default">
        ...
        <link type="text/css" rel="stylesheet" href="../renew/fonts/roboto.css">
        <link type="text/css" rel="stylesheet" href="../renew/css/layout.css">
        <link type="text/css" rel="stylesheet" href="../renew/fonts/glyphicons/glyphicons.css">
