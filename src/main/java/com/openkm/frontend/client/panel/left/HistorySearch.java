...
public class HistorySearch extends Composite {
	...
	public HistorySearch() {
		...
		stackPanel.add(scrollSearchSavedPanel, Util.createHeaderHTMLIconRenew("glyphicons glyphicons-search", Main.i18n("leftpanel.label.stored.search")), true, 32);
		stackPanel.add(scrollUserNewsSavedPanel, Util.createHeaderHTMLIconRenew("glyphicons glyphicons-newspaper", Main.i18n("leftpanel.label.user.search")), true, 32);
	...
	public void langRefresh() {
		stackPanel.setHeaderHTML(0, Util.createHeaderHTMLIconRenew("glyphicons glyphicons-search", Main.i18n("leftpanel.label.stored.search")));
		stackPanel.setHeaderHTML(1, Util.createHeaderHTMLIconRenew("glyphicons glyphicons-newspaper", Main.i18n("leftpanel.label.user.search")));
