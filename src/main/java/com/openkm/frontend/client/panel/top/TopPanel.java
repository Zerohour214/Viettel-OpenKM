...
public class TopPanel extends Composite {
	public static final int PANEL_HEIGHT = 86; // + (Util.getUserAgent().equals("gecko") ? 2 : 0);
	...
	public TopPanel() {
		...
		quickSearch.addKeyUpHandler(new KeyUpHandler() {
			...
			public void onKeyUp(KeyUpEvent event) {
				if (quickSearch.getText().length() >= 3) {
					searchImage.setHTML("<span class=\"glyphicons glyphicons-search icon-green-renew\"></span>");
				} else {
					searchImage.setHTML("<span class=\"glyphicons glyphicons-search icon-search-disable-renew\"></span>");
				}
		...
		quickSearch.setStyleName("okm-renew-search-input");
		quickSearch.addStyleName("okm-renew-search-input");
		quickSearch.addStyleName("white-place-holder");
		quickSearch.getElement().setPropertyString("placeholder", Main.i18n("button.search"));
		
		searchImage = new HTML("<span class=\"glyphicons glyphicons-search icon-search-disable-renew\"></span>");
		...
		searchImage.addStyleName("okm-renew-searchbox-image");
		HTMLPanel mapPanel = new HTMLPanel("");
		mapPanel.setStyleName("okm-renew-position-relative");
		mapPanel.add(searchImage);
		mapPanel.add(quickSearch);
		...
		panel.addStyleName("okm-renew-TopPanel");
