...
public class Navigator extends Composite {
	...
	public void langRefresh() {
		...
		if (stackPanel.isTaxonomyVisible()) {
			stackPanel.setHeaderHTML(count++, Util.createHeaderHTMLIconRenew("glyphicons glyphicons-flowchart", Main.i18n("leftpanel.label.taxonomy")));
			taxonomyTree.langRefresh();
		}
		if (stackPanel.isCategoriesVisible()) {
			stackPanel.setHeaderHTML(count++, Util.createHeaderHTMLIconRenew("glyphicons glyphicons-keys", Main.i18n("leftpanel.label.categories")));
			categoriesTree.langRefresh();
		}
		if (stackPanel.isMetadataVisible()) {
			stackPanel.setHeaderHTML(count++, Util.createHeaderHTMLIconRenew("glyphicons glyphicons-list-alt", Main.i18n("leftpanel.label.metadata")));
			metadataTree.langRefresh();
		}
		if (stackPanel.isThesaurusVisible()) {
			stackPanel.setHeaderHTML(count++, Util.createHeaderHTMLIconRenew("glyphicons glyphicons-book-open", Main.i18n("leftpanel.label.thesaurus")));
			thesaurusTree.langRefresh();
		}
		if (stackPanel.isTemplatesVisible()) {
			stackPanel.setHeaderHTML(count++, Util.createHeaderHTMLIconRenew("glyphicons glyphicons-article", Main.i18n("leftpanel.label.templates")));
			templateTree.langRefresh();
		}
		if (stackPanel.isPersonalVisible()) {
			stackPanel.setHeaderHTML(count++, Util.createHeaderHTMLIconRenew("glyphicons glyphicons-folder-open", Main.i18n("leftpanel.label.my.documents")));
			personalTree.langRefresh();
		}
		if (stackPanel.isMailVisible()) {
			stackPanel.setHeaderHTML(count++, Util.createHeaderHTMLIconRenew("glyphicons glyphicons-envelope", Main.i18n("leftpanel.label.mail")));
			mailTree.langRefresh();
		}
		if (stackPanel.isTrashVisible()) {
			stackPanel.setHeaderHTML(count++, Util.createHeaderHTMLIconRenew("glyphicons glyphicons-bin", Main.i18n("leftpanel.label.trash")));
	...
	private void refreshStartupContentPanels() {
		...
		if (stackPanel.isTaxonomyVisible()) {
			stackPanel.add(scrollTaxonomyPanel, Util.createHeaderHTMLIconRenew("glyphicons glyphicons-flowchart", Main.i18n("leftpanel.label.taxonomy")), true, UIDesktopConstants.STACK_HEIGHT);
		}
		if (stackPanel.isCategoriesVisible()) {
			stackPanel.add(scrollCategoriesPanel, Util.createHeaderHTMLIconRenew("glyphicons glyphicons-keys", Main.i18n("leftpanel.label.categories")), true, UIDesktopConstants.STACK_HEIGHT);
		}
		if (stackPanel.isMetadataVisible()) {
			stackPanel.add(scrollMetadataPanel, Util.createHeaderHTMLIconRenew("glyphicons glyphicons-list-alt", Main.i18n("leftpanel.label.metadata")), true, UIDesktopConstants.STACK_HEIGHT);
		}
		if (stackPanel.isThesaurusVisible()) {
			stackPanel.add(scrollThesaurusPanel, Util.createHeaderHTMLIconRenew("glyphicons glyphicons-book-open", Main.i18n("leftpanel.label.thesaurus")), true, UIDesktopConstants.STACK_HEIGHT);
		}
		if (stackPanel.isTemplatesVisible()) {
			stackPanel.add(scrollTemplatePanel, Util.createHeaderHTMLIconRenew("glyphicons glyphicons-article", Main.i18n("leftpanel.label.templates")), true, UIDesktopConstants.STACK_HEIGHT);
		}
		if (stackPanel.isPersonalVisible()) {
			stackPanel.add(scrollPersonalPanel, Util.createHeaderHTMLIconRenew("glyphicons glyphicons-folder-open", Main.i18n("leftpanel.label.my.documents")), true, UIDesktopConstants.STACK_HEIGHT);
		}
		if (stackPanel.isMailVisible()) {
			stackPanel.add(scrollMailPanel, Util.createHeaderHTMLIconRenew("glyphicons glyphicons-envelope", Main.i18n("leftpanel.label.mail")), true, UIDesktopConstants.STACK_HEIGHT);
		}
		if (stackPanel.isTrashVisible()) {
			stackPanel.add(scrollTrashPanel, Util.createHeaderHTMLIconRenew("glyphicons glyphicons-bin", Main.i18n("leftpanel.label.trash")), true, UIDesktopConstants.STACK_HEIGHT);
		}
