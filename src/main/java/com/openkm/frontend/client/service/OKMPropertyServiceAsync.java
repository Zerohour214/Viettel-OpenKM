...
public interface OKMPropertyServiceAsync {
	...
	public void addListKeywords(String nodePath, List<String> keyword, AsyncCallback<?> callback);

	public void removeKeyword(String nodePath, String keyword, AsyncCallback<?> callback);

	public void updateKeyword(String nodePath, AsyncCallback<?> callback);
}
