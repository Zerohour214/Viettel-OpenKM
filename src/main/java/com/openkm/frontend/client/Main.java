...
import com.openkm.frontend.client.widget.upload.VOfficePopup;
...
public final class Main implements EntryPoint, HasLanguageHandlerExtension, HasLanguageEvent {
	public static String CONTEXT = "/kms";
	...
	public void onModuleLoad2() {
		...
		mainPanel.setStyleName("okm-MainPanel");
		// Loading popup
		...
		vOffice = new VOfficePopup();
		vOffice.setStyleName("okm-Popup");
