...
public class Util {
	 ...
	 * @return
	 */
	public static String imageItemHTMLIcon(String icon, String title) {
		return "<span style='text-align:left; margin-right:4px;'><span align=\"absmidle\" style='margin-right:4px; white-space:nowrap;' class='"
				+ icon + " icon-folderTree-renew'" + ">" + title + "</span>";
	}
	 ...
	 * @return the resultant HTML
	 */
	public static String imageItemHTMLIcon(String icon, String title, String align) {
		return "<span style='text-align:left; margin-right:4px;'><span align=\"" + align
				+ "\" style='margin-right:4px; white-space:nowrap;' class='" + icon + " icon-folderTree-renew'></span>" + title + "</span>";
	}
	 ...
	 * @return the resultant HTML
	 */
	public static String imageItemHTMLIcon(String icon) {
		return "<span align=\"absmidle\" style='margin-right:4px' class='" + icon + "'></span>";
	}
	...
	public static String imageHTML(String imageUrl, String alt) {
		return "<img border=\"0\" align=\"absmidle\" alt=\"" + alt + "\" title=\"" + alt + "\" class='" + imageUrl.toLowerCase() + "'>";
	}
	 ...
	 * @return the resultant HTML
	 */
	public static String imageHTMLIcon(String icon, String alt) {
		return "<span border=\"0\" align=\"absmidle\" alt=\"" + alt + "\" title=\"" + alt + "\" class='" + icon + "'></span>";
	}
	 ...
	 * @return the resultant HTML
	 */
	public static String imageHTMLIcon(String icon) {
		return imageHTMLIcon(icon, "");
	}
	 ...
	 * Return the menu html value
	 *
	 * @param icon the glyphicon
	 * @param text     The text value
	 */
	public static String menuHTMLWithGlyphicon(String glyphicon, String text) {
		return "<span style='margin-right:8px; margin-left:2px; vertical-align:middle;' class='" + glyphicon + " child-menuitem-glyphicon-renew'></span>" + text;
	}
	 ...
	 * @return the header HTML fragment
	 */
	public static String createHeaderHTMLRenew(String imageUrl, String caption) {
		return "<table align='left' style=\"padding-left: 18px;\"><tr>" + "<td><img src='" + imageUrl + "'></td>" + "<td width=\"10px\"></td>"
	 ...
	 * @return the header HTML fragment
	 */
	public static String createHeaderHTMLIconRenew(String icon, String caption) {
		return "<table align='left' style=\"padding-left: 18px;\"><tr>" + "<td><span class='" + icon + "' style =\"	font-size: 15px; \"></span></td>" + "<td width=\"10px\"></td>"
				+ "<td style='vertical-align:middle'><b style='white-space:nowrap; cursor:default; font-size: 12px;'>" + caption + "</b></td>"
				+ "</tr></table>";
	}
