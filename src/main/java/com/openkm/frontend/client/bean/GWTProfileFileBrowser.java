...
public class GWTProfileFileBrowser implements IsSerializable {
	...
	private boolean docCodeVisible = true;
	private boolean docNameVisible = true;
	private boolean docEffectiveDateVisible = false;
	private boolean docOrgVisible = false;
	private boolean docConfidentialityVisible = true;
	private boolean docExpiredDateVisible = true;
	private boolean docAuthorVisible = false;
	private boolean publishComVisible = false;
	private boolean publishedYearVisible = false;
	private boolean pageNumberVisible = false;
	...
	private String docCodeWidth = "100";
	private String docNameWidth = "100";
	private String docEffectiveDateWidth = "100";
	private String docOrgWidth = "100";
	private String docConfidentialityWidth = "100";
	private String docExpiredDateWidth = "100";
	private String docAuthorWidth = "100";
	private String publishComWidth = "100";
	private String publishedYearWidth = "60";
	private String pageNumberWidth = "60";
	...
	public boolean isDocCodeVisible() {
		return docCodeVisible;
	}

	public void setDocCodeVisible(boolean docCodeVisible) {
		this.docCodeVisible = docCodeVisible;
	}

	public boolean isDocNameVisible() {
		return docNameVisible;
	}

	public void setDocNameVisible(boolean docNameVisible) {
		this.docNameVisible = docNameVisible;
	}

	public boolean isDocEffectiveDateVisible() {
		return docEffectiveDateVisible;
	}

	public void setDocEffectiveDateVisible(boolean docEffectiveDateVisible) {
		this.docEffectiveDateVisible = docEffectiveDateVisible;
	}

	public boolean isDocOrgVisible() {
		return docOrgVisible;
	}

	public void setDocOrgVisible(boolean docOrgVisible) {
		this.docOrgVisible = docOrgVisible;
	}
	public boolean isDocExpiredDateVisible() {
		return docExpiredDateVisible;
	}

	public void setDocExpiredDateVisible(boolean docExpiredDateVisible) {
		this.docExpiredDateVisible = docExpiredDateVisible;
	}

	public boolean isDocAuthorVisible() {
		return docAuthorVisible;
	}

	public void setDocAuthorVisible(boolean docAuthorVisible) {
		this.docAuthorVisible = docAuthorVisible;
	}

	public boolean isPublishComVisible() {
		return publishComVisible;
	}

	public void setPublishComVisible(boolean publishComVisible) {
		this.publishComVisible = publishComVisible;
	}

	public boolean isPublishedYearVisible() {
		return publishedYearVisible;
	}

	public void setPublishedYearVisible(boolean publishedYearVisible) {
		this.publishedYearVisible = publishedYearVisible;
	}
	...
	public String getDocExpiredDateWidth() {
		return docExpiredDateWidth;
	}

	public void setDocExpiredDateWidth(String docExpiredDateWidth) {
		this.docExpiredDateWidth = docExpiredDateWidth;
	}

	public String getDocAuthorWidth() {
		return docAuthorWidth;
	}

	public void setDocAuthorWidth(String docAuthorWidth) {
		this.docAuthorWidth = docAuthorWidth;
	}

	public String getPublishComWidth() {
		return publishComWidth;
	}

	public void setPublishComWidth(String publishComWidth) {
		this.publishComWidth = publishComWidth;
	}

	public String getPublishedYearWidth() {
		return publishedYearWidth;
	}

	public void setPublishedYearWidth(String publishedYear) {
		this.publishedYearWidth = publishedYear;
	}

	public String getPageNumberWidth() {
		return pageNumberWidth;
	}

	public void setPageNumberWidth(String pageNumber) {
		this.pageNumberWidth = pageNumber;
	}

	public boolean isDocConfidentialityVisible() {
		return docConfidentialityVisible;
	}

	public void setDocConfidentialityVisible(boolean docConfidentialityVisible) {
		this.docConfidentialityVisible = docConfidentialityVisible;
	}
	...
	public String getDocCodeWidth() {
		return docCodeWidth;
	}

	public void setDocCodeWidth(String docCodeWidth) {
		this.docCodeWidth = docCodeWidth;
	}

	public String getDocNameWidth() {
		return docNameWidth;
	}

	public void setDocNameWidth(String docNameWidth) {
		this.docNameWidth = docNameWidth;
	}

	public String getDocEffectiveDateWidth() {
		return docEffectiveDateWidth;
	}

	public void setDocEffectiveDateWidth(String docEffectiveDateWidth) {
		this.docEffectiveDateWidth = docEffectiveDateWidth;
	}

	public String getDocOrgWidth() {
		return docOrgWidth;
	}

	public void setDocOrgWidth(String docOrgWidth) {
		this.docOrgWidth = docOrgWidth;
	}

	public String getDocConfidentialityWidth() {
		return docConfidentialityWidth;
	}

	public void setDocConfidentialityWidth(String docConfidentialityWidth) {
		this.docConfidentialityWidth = docConfidentialityWidth;
	}
