...
public class GWTQueryParams implements IsSerializable, Cloneable {
	...
	public GWTQueryParams clone() {
		...
		newParans.setDocEffectiveDate(getDocEffectiveDate());
		newParans.setDocExpiredDate(getDocExpiredDate());
		newParans.setDocAuthor(getDocAuthor());
		newParans.setPublishCom(getPublishCom());
		newParans.setPublishedYear(getPublishedYear());
		newParans.setPageNumber(getPageNumber());
