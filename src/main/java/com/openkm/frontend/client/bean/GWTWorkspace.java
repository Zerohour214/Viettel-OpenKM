...
public class GWTWorkspace implements IsSerializable {
	...
	public void setTabDocumentRelatedVisible(boolean tabDocumentRelated) {
		this.tabDocumentRelatedVisible = tabDocumentRelated;
	}

	public boolean isTabDocumentActivityVisible() {
		return tabDocumentActivityVisible;
	}

	public void setTabDocumentActivityVisible(boolean tabDocumentActivityVisible) {
		this.tabDocumentActivityVisible = tabDocumentActivityVisible;
	}
