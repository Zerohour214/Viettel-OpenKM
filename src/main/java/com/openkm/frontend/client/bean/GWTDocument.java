...
public class GWTDocument implements IsSerializable {
	...
	public Date getDocExpiredDate() { return docExpiredDate; }

	public void setDocExpiredDate(Date docExpiredDate) { this.docExpiredDate = docExpiredDate; }
	...
	public int getPublishYear() { return publishedYear; }

	public void setPublishYear(int publishYear) { this.publishedYear = publishYear; }
	...
	public String toString() {
		...
		sb.append(", docName=");
		sb.append(docName);
		sb.append(", docEffectiveDate=");
		sb.append(docEffectiveDate);
		sb.append(", docOrgId=");
		sb.append(docOrgId);
		sb.append(", docConfidentiality=");
		sb.append(docConfidentiality);
		sb.append(", docConfidentialityName=");
		sb.append(docConfidentialityName);
