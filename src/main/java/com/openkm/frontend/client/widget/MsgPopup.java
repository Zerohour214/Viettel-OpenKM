...
public class MsgPopup extends DialogBox {
	...
	public MsgPopup() {
		...
		buttonClean = new Button(OkmConstants.ICON_CLEAN_BUTTON + Main.i18n("button.clean"), new ClickHandler() {
			@Override
	...
	public void langRefresh() {
		buttonClose.setHTML(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.close"));
		setTitle(Main.i18n("msg.title"));
	}
