...
public class KeyMapDashboard extends Composite {
	...
	public KeyMapDashboard() {
		...
		scrollTable.setStyleName("content-panel-renew");
		...
		small.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				if (table.getActualDetail() != KeyMapTable.VISIBLE_SMALL) {
					...
					small.setUrl("img/icon/actions/description_small_green.gif");
				}
			}
		});
		medium = new Image("img/icon/actions/description_medium_green.gif"); // It's enabled view by default
		medium.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				if (table.getActualDetail() != KeyMapTable.VISIBLE_MEDIUM) {
					...
					medium.setUrl("img/icon/actions/description_medium_green.gif");
				}
			}
		});
		...
		big.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				if (table.getActualDetail() != KeyMapTable.VISIBLE_BIG) {
					...
					big.setUrl("img/icon/actions/description_big_green.gif");
				}
			}
		});
		...
		imageControlPanel.setCellWidth(small, "25px");
		imageControlPanel.setCellWidth(medium, "25px");
		imageControlPanel.setCellWidth(big, "25px");
		imageControlPanel.setCellHeight(small, "25px");
		imageControlPanel.setCellHeight(medium, "25px");
		imageControlPanel.setCellHeight(big, "25px");
		...
		clean = new HTML("<span class=\"glyphicons glyphicons-minus-sign icon-disable-renew\"></span>");
	...
	private void refreshClean() {
		if (selectedKeyMap.keySet().size() > 0) {
			clean.setHTML("<span class=\"glyphicons glyphicons-minus-sign icon-red-renew\"></span>");
		} else {
			clean.setHTML("<span class=\"glyphicons glyphicons-minus-sign icon-disable-renew\"></span>");
		}
	}
