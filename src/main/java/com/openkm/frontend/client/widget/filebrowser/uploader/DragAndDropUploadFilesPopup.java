...
public class DragAndDropUploadFilesPopup extends DialogBox {
	...
	public DragAndDropUploadFilesPopup() {
		...
		buttonClose = new Button(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.close"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
				hide();
			}
		});
		buttonCancel = new Button(OkmConstants.ICON_DELETE_BUTTON + Main.i18n("button.cancel"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
				uploader.cancelTask(true);
			}
		});
		buttonClean = new Button(OkmConstants.ICON_CLEAN_BUTTON + Main.i18n("button.clean.completed"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
		...
		buttonClose.addStyleName("btn");
		buttonClose.addStyleName("btn-success");
		buttonCancel.setStyleName("okm-DeleteButton");
		buttonCancel.addStyleName("btn");
		buttonCancel.addStyleName("btn-danger");
		buttonClean.setStyleName("okm-CleanButton");
		buttonClean.addStyleName("btn");
		buttonClean.addStyleName("btn-danger");
		vPanel.add(sPanel);
