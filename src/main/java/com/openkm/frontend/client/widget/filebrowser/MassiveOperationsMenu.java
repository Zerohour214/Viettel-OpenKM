...
public class MassiveOperationsMenu extends MenuBase {
	...
	public MassiveOperationsMenu() {
		...
		selectAll = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-sort", Main.i18n("filebrowser.menu.select.all")), true, massiveSelectAll);
		selectAll.addStyleName("okm-MenuItem-strike");
		dirMenu.addItem(selectAll);
		selectFolders = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-folder-open", Main.i18n("filebrowser.menu.select.all.folders")), true, massiveSelectFolders);
		selectFolders.addStyleName("okm-MenuItem-strike");
		dirMenu.addItem(selectFolders);
		selectDocuments = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-file", Main.i18n("filebrowser.menu.select.all.documents")), true, massiveSelectDocuments);
		selectDocuments.addStyleName("okm-MenuItem-strike");
		dirMenu.addItem(selectDocuments);
		selectMails = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-envelope", Main.i18n("filebrowser.menu.select.all.mails")), true, massiveSelectMails);
		selectMails.addStyleName("okm-MenuItem-strike");
		dirMenu.addItem(selectMails);
		removeSelection = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-minus-sign", Main.i18n("filebrowser.menu.remove.selection")), true, massiveRemoveSelection);
	...
	public void langRefresh() {
		selectAll.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-sort", Main.i18n("filebrowser.menu.select.all")));
		selectFolders.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-folder-open", Main.i18n("filebrowser.menu.select.all.folders")));
		selectDocuments.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-file", Main.i18n("filebrowser.menu.select.all.documents")));
		selectMails.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-envelope", Main.i18n("filebrowser.menu.select.all.mails")));
		removeSelection.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-minus-sign", Main.i18n("filebrowser.menu.remove.selection")));
	}
