...
public class MailMenu extends MenuBase {
	...
	public MailMenu() {
		...
		remove = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-minus-sign", Main.i18n("tree.menu.directory.remove")), true, delFolder);
	...
	public void langRefresh() {
		...
		remove.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-minus-sign", Main.i18n("tree.menu.directory.remove")));
