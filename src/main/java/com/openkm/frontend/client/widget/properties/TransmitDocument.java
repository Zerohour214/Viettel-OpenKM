 ...
 *
 */
public class TransmitDocument extends Composite implements ClickHandler {
	...
	private String withPermission = "glyphicons glyphicons-ok icon-green-renew";
	private String withoutPermission = "glyphicons glyphicons-remove icon-red-renew";
	...
	public TransmitDocument() {
		...
		button = new Button(OkmConstants.ICON_EDIT_BUTTON + Main.i18n("button.update"), this);
	...
	public void langRefresh() {
		...
		button.setHTML(OkmConstants.ICON_EDIT_BUTTON + Main.i18n("button.update"));
		col++; // Button column
		headerTable.setHTML(0, col++, Main.i18n("security.user.name"));
		headerTable.setHTML(0, col++, Main.i18n("security.user.permission.read"));
		headerTable.setHTML(0, col++, Main.i18n("security.user.permission.write"));
	...
	private void addUserRow(GWTUser user, Integer permission) {
		...
		if ((permission & GWTPermission.READ) == GWTPermission.READ) {
			...
			dataTable.setHTML(rows, col, Util.imageItemHTMLIcon(withoutPermission, ""));
		}
