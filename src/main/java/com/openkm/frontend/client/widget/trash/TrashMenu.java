...
public class TrashMenu extends MenuBase {
	...
	public TrashMenu() {
		...
		restore = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-roundabout", Main.i18n("general.menu.file.restore")), true, restoreFolder);
		restore.addStyleName("okm-MenuItem");
		dirMenu.addItem(restore);
		purge = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-warning-sign", Main.i18n("general.menu.file.purge")), true, purgeFolder);
		purge.addStyleName("okm-MenuItem");
		dirMenu.addItem(purge);
		purgeTrash = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-bin", Main.i18n("general.menu.file.purge.trash")), true, purgeTrashFolder);
