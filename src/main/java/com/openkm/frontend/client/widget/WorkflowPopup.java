...
public class WorkflowPopup extends DialogBox implements WorkflowWidgetToFire {
	...
	public WorkflowPopup() {
		...
		addButton = new Button(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.start"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
	...
	public void langRefresh() {
		...
		addButton.setHTML(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.start"));
	}
