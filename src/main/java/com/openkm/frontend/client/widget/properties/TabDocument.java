...
public class TabDocument extends Composite implements HasDocumentEvent, HasDocumentHandlerExtension, HasPropertyGroupHandlerExtension {
	...
	public TabDocument() {
		...
		related = new RelatedScrollTable();
		activity = new ActivityDocumentTable();
	...
	public void setPixelSize(int width, int height) {
		...
		related.setPixelSize(width, height - TAB_HEIGHT);
		related.fillWidth();

		activity.setPixelSize(width, height - TAB_HEIGHT);
		activity.fillWidth();
	...
	public void langRefresh() {
		...
		if (relatedVisible) {
			tabPanel.add(related, Main.i18n("tab.document.related"));
			related.langRefresh();
		}
	...
	public void resizingIncubatorWidgets() {
		...
		related.setPixelSize(getOffsetWidth(), getOffsetHeight() - TAB_HEIGHT);
		activity.setPixelSize(getOffsetWidth(), getOffsetHeight() - TAB_HEIGHT);
