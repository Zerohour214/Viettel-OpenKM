...
public class ThesaurusPanel extends Composite {
	...
	public ThesaurusPanel() {
		...
		keyword = new TextBox();
		keyword.getElement().setAttribute("style", "box-sizing: content-box;padding-left: 8px;");
		keyword.setWidth("480px");
		...
		vPanelKeyword.setCellHorizontalAlignment(keyword, HasAlignment.ALIGN_CENTER);
