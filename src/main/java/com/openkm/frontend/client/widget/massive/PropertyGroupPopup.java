...
public class PropertyGroupPopup extends DialogBox implements ValidatorToFire {
	...
	public PropertyGroupPopup() {
		...
		cancel = new Button(OkmConstants.ICON_NO_BUTTON + Main.i18n("button.cancel"), new ClickHandler() {
			@Override
		...
		add = new Button(OkmConstants.ICON_ADD_BUTTON + Main.i18n("button.add"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
				addGroup();
			}
		...
		table.getCellFormatter().addStyleName(1, 0, "okm-Security-Title-renew");
	...
	public void langRefresh() {
		setText(Main.i18n("group.label"));
		cancel.setHTML(OkmConstants.ICON_NO_BUTTON + Main.i18n("button.cancel"));
		add.setHTML(OkmConstants.ICON_ADD_BUTTON + Main.i18n("button.add"));
	}
