	...
	public void evaluesFolderIcon(TreeItem item) {
		...
		if ((folderItem.getPermissions() & GWTPermission.WRITE) == GWTPermission.WRITE) {
			if (folderItem.isHasChildren()) {
				item.setHTML(Util.imageItemHTMLIcon("glyphicons glyphicons-folder-new icon-green-renew", folderItem.getName(), "top"));
			} else {
				item.setHTML(Util.imageItemHTMLIcon("glyphicons glyphicons-folder-open icon-green-renew", folderItem.getName(), "top"));
			}
		} else {
			if (folderItem.isHasChildren()) {
				item.setHTML(Util.imageItemHTMLIcon("glyphicons glyphicons-folder-new icon-red-renew", folderItem.getName(), "top"));
			} else {
				item.setHTML(Util.imageItemHTMLIcon("glyphicons glyphicons-folder-open icon-red-renew", folderItem.getName(), "top"));
			}
		}
	}
