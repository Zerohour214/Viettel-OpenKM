...
public class FindToolBarMenu extends DialogBox {
	...
	public FindToolBarMenu() {
		...
		findFolder = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-folder-open", Main.i18n("general.menu.file.find.folder")), true, findFolderOKM);
		findDocument = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-file", Main.i18n("general.menu.file.find.document")), true, findDocumentOKM);
		findSimilarDocument = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-sort", Main.i18n("general.menu.file.find.similar.document")), true, findSimilarOKM);
