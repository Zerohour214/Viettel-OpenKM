...
public class FolderSelectPopup extends DialogBox {
	...
	public FolderSelectPopup() {
		...
		actionButton = new Button(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.select"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
				if (categories) {
	...
	public void langRefresh() {
		...
		actionButton.setHTML(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.select"));
	}
