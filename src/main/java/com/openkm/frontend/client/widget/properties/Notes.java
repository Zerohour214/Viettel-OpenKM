...
public class Notes extends Composite {
	...
	public Notes(int type) {
		...
		updateButton = new Button(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.update"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
	...
	private void writeNote(final GWTNote note) {
		...
		HTML editNote = new HTML("<span class=\"glyphicons glyphicons-pen icon-green-renew\"></span>");
		HTML deleteNote = new HTML("<span class=\"glyphicons glyphicons-bin icon-green-renew\"></span>");
	...
	public void langRefresh() {
		...
		updateButton.setHTML(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.update"));
