...
public class ToolBar extends Composite implements OriginPanel, HasToolBarEvent, HasToolBarHandlerExtension {
	...
	private ToolBarButtonGlyphicon createFolder;
	private ToolBarButtonGlyphicon find;
	private ToolBarButtonGlyphicon download;
	private ToolBarButtonGlyphicon downloadPdf;
	private ToolBarButtonGlyphicon print;
	private ToolBarButtonGlyphicon lock;
	private ToolBarButtonGlyphicon unlock;
	private ToolBarButtonGlyphicon addDocument;
	private ToolBarButtonGlyphicon addVOffice;
	private ToolBarButtonGlyphicon checkout;
	private ToolBarButtonGlyphicon checkin;
	private ToolBarButtonGlyphicon cancelCheckout;
	private ToolBarButtonGlyphicon delete;
	private ToolBarButtonGlyphicon addPropertyGroup;
	private ToolBarButtonGlyphicon removePropertyGroup;
	private ToolBarButtonGlyphicon startWorkflow;
	private ToolBarButtonGlyphicon addSubscription;
	private ToolBarButtonGlyphicon removeSubscription;
	...
	ClickHandler addVOfficeHandler = new ClickHandler() {
		@Override
		public void onClick(ClickEvent event) {
			if (toolBarOption.addDocumentOption) {
				if (Main.get().mainPanel.bottomPanel.userInfo.isQuotaExceed()) {
	...
	public void executeAddVOffice() {
		FileToUpload fileToUpload = new FileToUpload();
		fileToUpload.setFileUpload(new FileUpload());
		fileToUpload.setPath(Main.get().activeFolderTree.getActualPath());
		fileToUpload.setAction(UIFileUploadConstants.ACTION_INSERT);
		Main.get().vOffice.showPopup();
		fireEvent(HasToolBarEvent.EXECUTE_ADD_DOCUMENT);
	}
	...
	public ToolBar() {
		...
		find = new ToolBarButtonGlyphicon(new HTML("<span class=\"glyphicons glyphicons-search\"></span>"), Main.i18n("general.menu.find"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
		...
		lock = new ToolBarButtonGlyphicon(new HTML("<span class=\"glyphicons glyphicons-lock\"></span>"), Main.i18n("general.menu.edit.lock"), lockHandler);

		unlock = new ToolBarButtonGlyphicon(new HTML("<span class=\"glyphicons glyphicons-unlock\"></span>"), Main.i18n("general.menu.edit.unlock"),
				unLockHandler);

		createFolder = new ToolBarButtonGlyphicon(new HTML("<span class=\"glyphicons glyphicons-folder-plus\"></span>"), Main.i18n("tree.menu.directory.create"),
				createFolderHandler);

		addDocument = new ToolBarButtonGlyphicon(new HTML("<span class=\"glyphicons glyphicons-file-plus\"></span>"), Main.i18n("general.menu.file.add.document"),
				addDocumentHandler);

		addVOffice = new ToolBarButtonGlyphicon(new HTML("<span class=\"glyphicons glyphicons-file-cloud\"></span>"), Main.i18n("general.menu.file.add.voffice"),
				addVOfficeHandler);

		delete = new ToolBarButtonGlyphicon(new HTML("<span class=\"glyphicons glyphicons-bin\"></span>"), Main.i18n("general.menu.edit.delete"),
				deleteHandler);

		checkout = new ToolBarButtonGlyphicon(new HTML("<span class=\"glyphicons glyphicons-pencil\"></span>"), Main.i18n("general.menu.edit.checkout"),
				editHandler);

		checkin = new ToolBarButtonGlyphicon(new HTML("<span class=\"glyphicons glyphicons-ok\"></span>"), Main.i18n("general.menu.edit.checkin"),
				checkinHandler);

		cancelCheckout = new ToolBarButtonGlyphicon(new HTML("<span class=\"glyphicons glyphicons-remove\"></span>"),
				Main.i18n("general.menu.edit.cancel.checkout"), cancelCheckoutHandler);

		download = new ToolBarButtonGlyphicon(new HTML("<span class=\"glyphicons glyphicons-download-alt\"></span>"),
				Main.i18n("general.menu.file.download.document"), downloadHandler);

		downloadPdf = new ToolBarButtonGlyphicon(new HTML("<span class=\"glyphicons glyphicons-file-cloud-download\"></span>"),
				Main.i18n("general.menu.file.download.document.pdf"), downloadPdfHandler);

		print = new ToolBarButtonGlyphicon(new HTML("<span class=\"glyphicons glyphicons-print\"></span>"), Main.i18n("general.menu.file.print"),
				printHandler);

		addPropertyGroup = new ToolBarButtonGlyphicon(new HTML("<span class=\"glyphicons glyphicons-plus\"></span>"),
				Main.i18n("general.menu.edit.add.property.group"), addPropertyGroupHandler);

		removePropertyGroup = new ToolBarButtonGlyphicon(new HTML("<span class=\"glyphicons glyphicons-minus\"></span>"),
				Main.i18n("general.menu.edit.remove.property.group"), removePropertyGroupHandler);

		startWorkflow = new ToolBarButtonGlyphicon(new HTML("<span class=\"glyphicons glyphicons-cogwheel\"></span>"),
				Main.i18n("general.menu.file.start.workflow"), startWorkflowHandler);

		addSubscription = new ToolBarButtonGlyphicon(new HTML("<span class=\"glyphicons glyphicons-message-plus\"></span>"),
				Main.i18n("general.menu.edit.add.subscription"), addSubscriptionHandler);

		removeSubscription = new ToolBarButtonGlyphicon(new HTML("<span class=\"glyphicons glyphicons-message-minus\"></span>"),
				Main.i18n("general.menu.edit.remove.subscription"), removeSubscriptionHandler);

		home = new ToolBarButtonGlyphicon(new HTML("<span class=\"glyphicons glyphicons-home\"></span>"), Main.i18n("general.menu.bookmark.home"), arrowHomeHandler);

		refresh = new ToolBarButtonGlyphicon(new HTML("<span class=\"glyphicons glyphicons-refresh\"></span>"), Main.i18n("general.menu.file.refresh"),
				arrowRefreshHandler);

		splitterResize = new ToolBarButtonGlyphicon(new HTML("<span class=\"glyphicons glyphicons-resize-horizontal\"></span>"),
		...
		addVOffice.addMouseOverHandler(mouseOverHandler);
		addVOffice.addMouseOutHandler(mouseOutHandler);
		...
		addVOffice.setStyleName("okm-ToolBar-button");
		...
		panel.addStyleName("okm-renew-ToolBar");
		panel.add(space());
		panel.add(find);
		panel.add(space());
		panel.add(download);
	...
	public void enableCreateFolder() {
		toolBarOption.createFolderOption = true;
		createFolder.setStyleName("okm-ToolBar-button");
		createFolder.addStyleName("okm-ToolBar-button-renew");
	...
	public void disableCreateFolder() {
		...
		createFolder.addStyleName("okm-ToolBar-button-disabled-renew");
		createFolder.setTitle(Main.i18n("tree.menu.directory.create"));
	}
	...
	public void enableFind() {
		toolBarOption.findOption = true;
		find.setStyleName("okm-ToolBar-button");
		find.addStyleName("okm-ToolBar-button-renew");
	...
	public void disableFind() {
		...
		find.addStyleName("okm-ToolBar-button-disabled-renew");
		find.setTitle(Main.i18n("general.menu.find"));
	}
	...
	public void enableCheckout() {
		...
		checkout.addStyleName("okm-ToolBar-button-renew");
	...
	public void disableCheckout() {
		toolBarOption.checkoutOption = false;
		checkout.setStyleName("okm-ToolBar-button-disabled");
		checkout.addStyleName("okm-ToolBar-button-disabled-renew");
		checkout.setTitle(Main.i18n("general.menu.edit.checkout"));
	}
	...
	public void enableCheckin() {
		...
		checkin.addStyleName("okm-ToolBar-button-renew");
	...
	public void disableCheckin() {
		toolBarOption.checkinOption = false;
		checkin.setStyleName("okm-ToolBar-button-disabled");
		checkin.addStyleName("okm-ToolBar-button-disabled-renew");
		checkin.setTitle(Main.i18n("general.menu.edit.checkin"));
	}
	...
	public void enableCancelCheckout() {
		...
		cancelCheckout.addStyleName("okm-ToolBar-button-renew");
	...
	public void disableCancelCheckout() {
		toolBarOption.cancelCheckoutOption = false;
		cancelCheckout.setStyleName("okm-ToolBar-button-disabled");
		cancelCheckout.addStyleName("okm-ToolBar-button-disabled-renew");
		cancelCheckout.setTitle(Main.i18n("general.menu.edit.cancel.checkout"));
	}
	...
	public void disableLock() {
		...
		lock.addStyleName("okm-ToolBar-button-disabled-renew");
	...
	public void enableLock() {
		toolBarOption.lockOption = true;
		lock.setStyleName("okm-ToolBar-button");
		lock.addStyleName("okm-ToolBar-button-renew");
		lock.setTitle(Main.i18n("general.menu.edit.lock"));
	}
	...
	public void disableUnlock() {
		...
		unlock.addStyleName("okm-ToolBar-button-disabled-renew");
	...
	public void enableUnlock() {
		toolBarOption.unLockOption = true;
		unlock.setStyleName("okm-ToolBar-button");
		unlock.addStyleName("okm-ToolBar-button-renew");
		unlock.setTitle(Main.i18n("general.menu.edit.unlock"));
	}
	...
	public void disableDownload() {
		...
		download.setStyleName("okm-ToolBar-button-disabled");
		download.addStyleName("okm-ToolBar-button-disabled-renew");
	...
	public void enableDownload() {
		...
		download.addStyleName("okm-ToolBar-button-renew");
		download.setTitle(Main.i18n("general.menu.file.download.document"));
	}
	...
	public void disableDownloadPdf() {
		toolBarOption.downloadPdfOption = false;
		downloadPdf.setStyleName("okm-ToolBar-button-disabled");
		downloadPdf.addStyleName("okm-ToolBar-button-disabled-renew");
	...
	public void enableDownloadPdf() {
		...
		downloadPdf.addStyleName("okm-ToolBar-button-renew");
		downloadPdf.setTitle(Main.i18n("general.menu.file.download.document.pdf"));
	}
	...
	public void disablePrint() {
		...
		print.setStyleName("okm-ToolBar-button-disabled");
		print.addStyleName("okm-ToolBar-button-disabled-renew");
	...
	public void enablePrint() {
		...
		print.addStyleName("okm-ToolBar-button-renew");
		print.setTitle(Main.i18n("general.menu.file.print"));
	}
	...
	public void disableDelete() {
		toolBarOption.deleteOption = false;
		delete.setStyleName("okm-ToolBar-button-disabled");
		delete.addStyleName("okm-ToolBar-button-disabled-renew");
	...
	public void enableDelete() {
		...
		delete.addStyleName("okm-ToolBar-button-renew");
		delete.setTitle(Main.i18n("general.menu.edit.delete"));
	}
	...
	public void disableRefresh() {
		...
		refresh.setStyleName("okm-ToolBar-button-disabled");
		refresh.addStyleName("okm-ToolBar-button-disabled-renew");
	...
	public void enableRefresh() {
		...
		refresh.addStyleName("okm-ToolBar-button-renew");
		refresh.setTitle(Main.i18n("general.menu.file.refresh"));
	}
	...
	public void disableAddDocument() {
		...
		addDocument.addStyleName("okm-ToolBar-button-disabled-renew");
		addDocument.setTitle(Main.i18n("general.menu.file.add.document"));
		addVOffice.setStyleName("okm-ToolBar-button-disabled");
		addVOffice.addStyleName("okm-ToolBar-button-disabled-renew");
		addVOffice.setTitle(Main.i18n("general.menu.file.add.voffice"));
	}
	...
	public void enableAddDocument() {
		toolBarOption.addDocumentOption = true;
		addDocument.setStyleName("okm-ToolBar-button");
		addDocument.addStyleName("okm-ToolBar-button-renew");
		addDocument.setTitle(Main.i18n("general.menu.file.add.document"));
		addVOffice.setStyleName("okm-ToolBar-button");
		addVOffice.addStyleName("okm-ToolBar-button-renew");
		addVOffice.setTitle(Main.i18n("general.menu.file.add.voffice"));
	}
	...
	public void disableAddPropertyGroup() {
		...
		toolBarOption.addPropertyGroupOption = false;
		addPropertyGroup.setStyleName("okm-ToolBar-button-disabled");
		addPropertyGroup.addStyleName("okm-ToolBar-button-disabled-renew");
	...
	public void enableAddPropertyGroup() {
		...
		addPropertyGroup.addStyleName("okm-ToolBar-button-renew");
		addPropertyGroup.setTitle(Main.i18n("general.menu.edit.add.property.group"));
	}
	...
	public void disableAddSubscription() {
		toolBarOption.addSubscription = false;
		addSubscription.setStyleName("okm-ToolBar-button-disabled");
		addSubscription.addStyleName("okm-ToolBar-button-disabled-renew");
	...
	public void enableAddSubscription() {
		...
		addSubscription.addStyleName("okm-ToolBar-button-renew");
		addSubscription.setTitle(Main.i18n("general.menu.edit.add.subscription"));
	}
	...
	public void disableRemoveSubscription() {
		toolBarOption.removeSubscription = false;
		removeSubscription.setStyleName("okm-ToolBar-button-disabled");
		removeSubscription.addStyleName("okm-ToolBar-button-disabled-renew");
	...
	public void enableRemoveSubscription() {
		...
		removeSubscription.addStyleName("okm-ToolBar-button-renew");
		removeSubscription.setTitle(Main.i18n("general.menu.edit.remove.subscription"));
	}
	...
	public void disableHome() {
		...
		home.setStyleName("okm-ToolBar-button-disabled");
		home.addStyleName("okm-ToolBar-button-disabled-renew");
	...
	public void enableHome() {
		...
		home.addStyleName("okm-ToolBar-button-renew");
		home.setTitle(Main.i18n("general.menu.bookmark.home"));
	}
	...
	public void disableWorkflow() {
		...
		startWorkflow.setStyleName("okm-ToolBar-button-disabled");
		startWorkflow.addStyleName("okm-ToolBar-button-disabled-renew");
	...
	public void enableWorkflow() {
		...
		startWorkflow.addStyleName("okm-ToolBar-button-renew");
		startWorkflow.setTitle(Main.i18n("general.menu.file.start.workflow"));
	}
	...
	public void disableSplitterResize() {
		...
		splitterResize.setStyleName("okm-ToolBar-button-disabled");
		splitterResize.addStyleName("okm-ToolBar-button-disabled-renew");
	...
	public void enableSplitterResize() {
		...
		splitterResize.addStyleName("okm-ToolBar-button-renew");
		splitterResize.setTitle(Main.i18n("general.menu.splitter.resize"));
	}
	...
	public void disableOmr() {
		...
		omr.setStyleName("okm-ToolBar-button-disabled");
		omr.addStyleName("okm-ToolBar-button-disabled-renew");
	...
	public void enableOmr() {
		...
		omr.addStyleName("okm-ToolBar-button-renew");
	...
	public void evaluateShowIcons() {
		...
		if (!toolBarOption.removePropertyGroupOption) {
			...
			// option )
			removePropertyGroup.setStyleName("okm-ToolBar-button-disabled");
			removePropertyGroup.addStyleName("okm-ToolBar-button-disabled-renew");
	...
	public void evaluateRemovePropertyGroup(boolean propertyGroupEnabled) {
		...
		if (toolBarOption.removePropertyGroupOption && toolBarOption.firedRemovePropertyGroupOption) {
			...
			removePropertyGroup.addStyleName("okm-ToolBar-button-renew");
			removePropertyGroup.setTitle(Main.i18n("general.menu.edit.remove.property.group"));
	...
	public void setAvailableOption(GWTProfileToolbar option) {
		...
		// space
		addVOffice.setVisible(option.isAddDocumentVisible());
		panel.getWidget(20).setVisible(option.isAddDocumentVisible()); // hide
		// space
		checkout.setVisible(option.isCheckoutVisible());
		panel.getWidget(22).setVisible(option.isCheckoutVisible()); // hide
		// space
		...
		panel.getWidget(31).setVisible(option.isAddPropertyGroupVisible()); // hide
		// space
		removePropertyGroup.setVisible(option.isRemovePropertyGroupVisible());
		panel.getWidget(33).setVisible(option.isRemovePropertyGroupVisible()); // hide
		// space
		panel.getWidget(34).setVisible(option.isAddPropertyGroupVisible() || option.isRemovePropertyGroupVisible()); // hide
		// separator

		// FIFTH
		startWorkflow.setVisible(option.isStartWorkflowVisible());
		panel.getWidget(36).setVisible(option.isStartWorkflowVisible()); // hide
		// space
		panel.getWidget(37).setVisible(option.isStartWorkflowVisible()); // hide
		// separator

		// SIXTH
		addSubscription.setVisible(option.isAddSubscriptionVisible());
		panel.getWidget(39).setVisible(option.isAddSubscriptionVisible()); // hide
		// space
		removeSubscription.setVisible(option.isRemoveSubscriptionVisible());
		panel.getWidget(41).setVisible(option.isRemoveSubscriptionVisible()); // hide
		// space
		panel.getWidget(42).setVisible(option.isAddSubscriptionVisible() || option.isRemoveSubscriptionVisible()); // hide
		// separator

		// SEVENTH
		refresh.setVisible(option.isRefreshVisible());
		panel.getWidget(44).setVisible(option.isRefreshVisible()); // hide space
		home.setVisible(option.isHomeVisible());
		panel.getWidget(46).setVisible(option.isHomeVisible()); // hide space
		panel.getWidget(47).setVisible(option.isHomeVisible() || option.isRefreshVisible()); // hide
		// separator
		splitterResize.setVisible(option.isSplitterResizeVisible());
		panel.getWidget(49).setVisible(option.isSplitterResizeVisible()); // hide
		// space
