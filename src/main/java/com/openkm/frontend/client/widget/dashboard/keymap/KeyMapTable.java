...
public class KeyMapTable extends Composite {
	...
	private void addDocumentRow(GWTQueryResult gwtQueryResult, Score score) {
		...
		HTML gotoDocument = new HTML("<span class=\"glyphicons glyphicons-file-export icon-green-renew\"></span>");
		...
		if (doc.isAttachment()) {
			...
			sp.add(new HTML(Util.imageItemHTMLIcon("glyphicons glyphicons-message-new icon-green-renew") + Util.mimeImageHTML(doc.getMimeType())));
	...
	private void addFolderRow(GWTQueryResult gwtQueryResult, Score score) {
		...
		HTML gotoFolder = new HTML("<span class=\"glyphicons glyphicons-folder-flag icon-green-renew\"></span>");
		...
		if (folder.isHasChildren()) {
			sp.add(new HTML(Util.imageItemHTMLIcon("glyphicons glyphicons-folder-new icon-green-renew")));
		} else {
			sp.add(new HTML(Util.imageItemHTMLIcon("glyphicons glyphicons-folder-open icon-green-renew")));
		}
	...
	private void addMailRow(GWTQueryResult gwtQueryResult, Score score) {
		...
		HTML gotoMail = new HTML("<span class=\"glyphicons glyphicons-file-export icon-green-renew\"></span>");
		...
		if (mail.getAttachments().size() > 0) {
			sp.add(new HTML(Util.imageItemHTMLIcon("glyphicons glyphicons-message-new icon-green-renew")));
		} else {
			sp.add(new HTML(Util.imageItemHTMLIcon("glyphicons glyphicons-envelope icon-green-renew")));
		}
		table.setWidget(rows, 1, sp);
		Hyperlink hLink = new Hyperlink();
