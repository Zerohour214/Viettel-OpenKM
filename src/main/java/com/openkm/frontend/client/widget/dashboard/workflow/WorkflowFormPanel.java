...
public class WorkflowFormPanel extends Composite implements HasWorkflow, ValidatorToFire {
	...
	public WorkflowFormPanel() {
		...
		add = new Button("<span class=\"glyphicons glyphicons-plus\"></span>" + Main.i18n("button.add"), new ClickHandler() {
			@Override
		...
		submitForm = new Button(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.accept"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
		...
		submitForm.addStyleName("btn");
		submitForm.addStyleName("btn-success");
		add.setStyleName("okm-AddButton");
		add.addStyleName("btn");
		add.addStyleName("btn-success");
	...
	public void langRefresh() {
		...
		submitForm.setHTML(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.accept"));
		addComment.setHTML("<b>" + Main.i18n("dashboard.workflow.add.comment") + "</b>");
		add.setText("<span class=\"glyphicons glyphicons-plus\"></span>" + Main.i18n("button.add"));
	}
	...
	class TitleWidget extends HorizontalPanel implements HasClickHandlers {
		...
		public TitleWidget(String text, int[] relatedRows) {
			...
			if (zoom) {
				zoomImage = new HTML("<span class=\"glyphicons glyphicons-zoom-out icon-green-renew icon-DashboardWidget-renew\" style=\"padding: 0 10px;\"></span>");
			} else {
				zoomImage = new HTML("<span class=\"glyphicons glyphicons-zoom-in icon-green-renew icon-DashboardWidget-renew\" style=\"padding: 0 10px;\"></span>");
			}
		...
		public void setVisibleRows(boolean zoom) {
			...
			if (zoom) {
				zoomImage.setHTML("<span class=\"glyphicons glyphicons-zoom-out icon-green-renew icon-DashboardWidget-renew\" style=\"padding: 0 10px;\"></span>");
			} else {
				zoomImage.setHTML("<span class=\"glyphicons glyphicons-zoom-in icon-green-renew icon-DashboardWidget-renew\" style=\"padding: 0 10px;\"></span>");
			}
		}
