...
public class WizardPopup extends DialogBox implements ValidatorToFire {
	...
	public WizardPopup() {
		...
		actualButton.addStyleName("btn");
		actualButton.addStyleName("btn-success");
	...
	private Button acceptButton() {
		Button button = new Button(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.accept"), new ClickHandler() {
			@Override
	...
	private Button nextButton() {
		Button button = new Button(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.next"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
				actualButton.setEnabled(false);
				executeActionButton();
