...
public class ResizeToolBarMenu extends DialogBox {
	...
	public ResizeToolBarMenu() {
		...
		normalView = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-bring-forward", Main.i18n("general.menu.resize.normal")), true, new Command() {
			@Override
			public void execute() {
				restoreToNormal();
				hide();
		...
		closeTreeView = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-send-to-back", Main.i18n("general.menu.resize.close.tree")), true, new Command() {
			@Override
			public void execute() {
		...
		closePropertiesView = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-send-backward", Main.i18n("general.menu.resize.close.properties")), true, new Command() {
			@Override
			public void execute() {
		...
		expandTreeView = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-bring-to-front", Main.i18n("general.menu.resize.expand.tree")), true, new Command() {
			@Override
			public void execute() {
		...
		expandFileBrowserView = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-folder-closed", Main.i18n("general.menu.resize.expand.filebrowser")), true, new Command() {
			@Override
			public void execute() {
		...
		expandPropertiesView = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-list-alt", Main.i18n("general.menu.resize.expand.properties")), true, new Command() {
			@Override
			public void execute() {
