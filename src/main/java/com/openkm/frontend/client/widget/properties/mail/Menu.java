...
public class Menu extends MenuBase {
	...
	public Menu() {
		...
		all = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-sort", Main.i18n("mail.menu.show.all")), true, commandShowAll);
		all.addStyleName("okm-MenuItem");
		mailMenu.addItem(all);
		cc = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-file", Main.i18n("mail.menu.show.cc")), true, commandShowCC);
		cc.addStyleName("okm-MenuItem");
		mailMenu.addItem(cc);
		bcc = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-file", Main.i18n("mail.menu.show.bcc")), true, commandShowBCC);
		bcc.addStyleName("okm-MenuItem");
		mailMenu.addItem(bcc);
		reply = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-file", Main.i18n("mail.menu.show.reply")), true, commandShowReply);
		reply.addStyleName("okm-MenuItem");
		mailMenu.addItem(reply);
		extra = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-file", Main.i18n("mail.menu.show.extre")), true, commandShowExtra);
