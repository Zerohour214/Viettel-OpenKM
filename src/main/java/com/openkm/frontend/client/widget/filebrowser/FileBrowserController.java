...
public class FileBrowserController extends Composite {
	...
	public Map<String, GWTFilter> getFilter() {
		...
		for (String key : fPopup.getMapFilter().keySet()) {
			if (key.equals(String.valueOf(GWTPaginated.COL_NAME)) || key.equals(String.valueOf(GWTPaginated.COL_AUTHOR)) ||
					key.equals(String.valueOf(GWTPaginated.COL_VERSION)) || key.equals(String.valueOf(GWTPaginated.COL_DOC_CODE)) ||
					key.equals(String.valueOf(GWTPaginated.COL_DOC_NAME)) || key.equals(String.valueOf(GWTPaginated.COL_DOC_ORG)) ||
					key.equals(String.valueOf(GWTPaginated.COL_DOC_CONFIDENTIALITY)) || key.equals(String.valueOf(GWTPaginated.COL_DOC_AUTHOR)) ||
					key.equals(String.valueOf(GWTPaginated.COL_PUBLISH_COM)) || key.equals(String.valueOf(GWTPaginated.COL_PAGE_NUMBER)) ||
					key.equals(String.valueOf(GWTPaginated.COL_PUBLISHED_YEAR)) ) {
			...
			} else if (key.equals(String.valueOf(GWTPaginated.COL_DATE)) || key.equals(String.valueOf(GWTPaginated.COL_DOC_EFFECTIVE_DATE)) ||
					key.equals(String.valueOf(GWTPaginated.COL_DOC_EXPIRED_DATE))) {
				GWTFilter filter = fPopup.getMapFilter().get(key);
	...
	private class FilterPopup extends DialogBox {
		...
		public FilterPopup() {
			...
			// accept
			accept = new Button(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.accept"));
			...
			accept.addStyleName("btn");
			accept.addStyleName("btn-success");
		...
		public void reset() {
			...
			for (String key : map.keySet()) {
				if (key.equals(String.valueOf(GWTPaginated.COL_NAME)) || key.equals(String.valueOf(GWTPaginated.COL_AUTHOR)) ||
						...
						key.equals(String.valueOf(GWTPaginated.COL_DOC_NAME)) || key.equals(String.valueOf(GWTPaginated.COL_DOC_ORG)) ||
						key.equals(String.valueOf(GWTPaginated.COL_DOC_CONFIDENTIALITY)) || key.equals(String.valueOf(GWTPaginated.COL_DOC_AUTHOR)) ||
						key.equals(String.valueOf(GWTPaginated.COL_PUBLISH_COM)) ||
						key.equals(String.valueOf(GWTPaginated.COL_PUBLISHED_YEAR)) || key.equals(String.valueOf(GWTPaginated.COL_PAGE_NUMBER))) {
					int row = table.getRowCount();
		...
		private void updateMapFilter() {
			for (int row = 1; row < table.getRowCount(); row++) {
				...
				if (key.equals(String.valueOf(GWTPaginated.COL_NAME)) || key.equals(String.valueOf(GWTPaginated.COL_AUTHOR)) ||
						...
						key.equals(String.valueOf(GWTPaginated.COL_DOC_NAME)) || key.equals(String.valueOf(GWTPaginated.COL_DOC_ORG)) ||
						key.equals(String.valueOf(GWTPaginated.COL_DOC_CONFIDENTIALITY)) || key.equals(String.valueOf(GWTPaginated.COL_DOC_AUTHOR)) ||
						key.equals(String.valueOf(GWTPaginated.COL_PUBLISH_COM)) || key.equals(String.valueOf(GWTPaginated.COL_PUBLISHED_YEAR)) ||
						key.equals(String.valueOf(GWTPaginated.COL_PAGE_NUMBER))) {
		 ...
		 */
		public void langRefresh() {
			accept.setHTML(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.accept"));
			setText(Main.i18n("filebrowser.controller.filter"));
		}
