...
public class MetadataMenu extends MenuBase {
	...
	public MetadataMenu() {
		...
		go = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-copy", Main.i18n("search.result.menu.go.folder")), true, goDirectory);
	...
	public void langRefresh() {
		...
		rename.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-font", Main.i18n("general.menu.edit.rename")));
		...
		go.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-copy", Main.i18n("search.result.menu.go.folder")));
	}
	 ...
	 */
	public void hide() {
		Main.get().mainPanel.desktop.browser.fileBrowser.metadataMenuPopup.hide();
	}
}