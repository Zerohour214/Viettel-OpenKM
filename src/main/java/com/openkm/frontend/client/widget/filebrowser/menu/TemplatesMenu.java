...
public class TemplatesMenu extends MenuBase {
	...
	public TemplatesMenu() {
		...
		download = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-download-alt", Main.i18n("filebrowser.menu.download")), true, downloadFile);
		download.addStyleName("okm-MenuItem-strike");
		dirMenu.addItem(download);
		checkout = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-pencil", Main.i18n("filebrowser.menu.checkout")), true, checkoutFile);
		checkout.addStyleName("okm-MenuItem-strike");
		dirMenu.addItem(checkout);
		checkin = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-ok", Main.i18n("filebrowser.menu.checkin")), true, checkinFile);
		checkin.addStyleName("okm-MenuItem-strike");
		dirMenu.addItem(checkin);
		cancelCheckout = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-remove", Main.i18n("filebrowser.menu.checkout.cancel")), true, cancelCheckinFile);
		cancelCheckout.addStyleName("okm-MenuItem-strike");
		dirMenu.addItem(cancelCheckout);
		lock = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-lock", Main.i18n("filebrowser.menu.lock")), true, lockFile);
		...
		createFromTemplate = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-article", Main.i18n("general.menu.file.create.from.template")), true, createFileFromTemplate);
	...
	public void langRefresh() {
		...
		createFromTemplate.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-article", Main.i18n("general.menu.file.create.from.template")));
	}
