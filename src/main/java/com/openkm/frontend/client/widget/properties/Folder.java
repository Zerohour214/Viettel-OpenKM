...
public class Folder extends Composite {
	...
	public Folder() {
		...
		tableProperties2.setHTML(0, 0, "<b>" + Main.i18n("folder.url") + "</b>");
		tableProperties2.setWidget(0, 1, new HTML(""));
		tableProperties2.setHTML(1, 0, "<b>" + Main.i18n("folder.webdav") + "</b>");
		...
		tableProperties3.setWidget(0, 0, hPanelSubscribedUsers);
		tableProperties3.setWidget(0, 1, tableSubscribedUsers);
		tableProperties3.setWidget(1, 0, keywordManager.getKeywordCloudText());
		tableProperties3.setWidget(1, 1, keywordManager.getKeywordCloud());
		tableProperties3.setWidget(2, 0, categoryManager.getPanelCategories());
		tableProperties3.setWidget(2, 1, categoryManager.getSubscribedCategoriesTable());
	...
	public void set(GWTFolder fld) {
		...
		hPanel.add(new ClipboardIcon(folder.getUuid()));
		...
		tableProperties2.setWidget(0, 1, new ClipboardIcon(url));
		...
		tableProperties2.setWidget(1, 1, new ClipboardIcon(webdavUrl));
	}
	...
	public void addListKeywords(List<String> keywords) {
		keywordManager.addListKeywords(keywords);
	}
