...
public class MailDashboard extends Composite {
	...
	public MailDashboard() {
		...
		userLastImportedMails = new DashboardWidget("UserLastImportedMails",
				"dashboard.mail.last.imported.mails", "glyphicons glyphicons-envelope icon-green-renew icon-DashboardWidget-renew", true, "userLastImportedMails");
		userLastImportedAttachments = new DashboardWidget("UserLastImportedMailAttachments",
				"dashboard.mail.last.imported.attached.documents", "glyphicons glyphicons-paperclip icon-green-renew icon-DashboardWidget-renew", true,
