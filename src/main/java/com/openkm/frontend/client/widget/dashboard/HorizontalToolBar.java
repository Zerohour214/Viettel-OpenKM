...
public class HorizontalToolBar extends Composite {
	...
	public HorizontalToolBar() {
		...
		user = new ToolBarBox(new HTML("<span class=\"glyphicons glyphicons-user\" style=\"font-size: 21px; color: #27B45F;\"></span>"), Main.i18n("dashboard.tab.user"));
		mail = new ToolBarBox(new HTML("<span class=\"glyphicons glyphicons-envelope\" style=\"font-size: 21px; color: #27B45F;\"></span>"), Main.i18n("dashboard.tab.mail"));
		news = new ToolBarBox(new HTML("<span class=\"glyphicons glyphicons-info-sign\" style=\"font-size: 21px; color: #27B45F;\"></span>"), Main.i18n("dashboard.tab.news"));
		general = new ToolBarBox(new HTML("<span class=\"glyphicons glyphicons-globe-af\" style=\"font-size: 21px; color: #27B45F;\"></span>"), Main.i18n("dashboard.tab.general"));
		workflow = new ToolBarBox(new HTML("<span class=\"glyphicons glyphicons-cogwheels\" style=\"font-size: 21px; color: #27B45F;\"></span>"), Main.i18n("dashboard.tab.workflow"));
		keywordMap = new ToolBarBox(new HTML("<span class=\"glyphicons glyphicons-text-background\" style=\"font-size: 21px; color: #27B45F;\"></span>"), Main.i18n("dashboard.tab.keymap"));
		...
		hPanel.setStyleName("okm-ToolBar-control-tab-renew");
