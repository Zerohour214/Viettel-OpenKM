...
public class PropertyGroup extends Composite implements HasPropertyGroupHandlerExtension, ValidatorToFire {
	...
	public PropertyGroup(GWTPropertyGroup propertyGroup, final Object node, boolean visible, boolean readOnly) {
		...
		changeButton = new Button(OkmConstants.ICON_EDIT_BUTTON + Main.i18n("button.change"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
				if (!editValues) {
					Main.get().mainPanel.disableKeyShorcuts(); // Disables key shortcuts while updating
					changeButton.setHTML(OkmConstants.ICON_EDIT_BUTTON + Main.i18n("button.memory"));
		...
		removeButton = new Button(OkmConstants.ICON_DELETE_BUTTON + Main.i18n("button.delete"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
				if (!editValues) {
		...
		cancelButton = new Button(OkmConstants.ICON_NO_BUTTON + Main.i18n("button.cancel"), new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				if (editValues) {
					...
					changeButton.setHTML(OkmConstants.ICON_EDIT_BUTTON + Main.i18n("button.change"));
					editValues = false;
					cancelEdit();
		...
		changeButton.addStyleName("btn");
		changeButton.addStyleName("btn-success");
		removeButton.setStyleName("okm-DeleteButton");
		removeButton.addStyleName("btn");
		removeButton.addStyleName("btn-danger");
	...
	public void langRefresh() {
		changeButton.setHTML(OkmConstants.ICON_EDIT_BUTTON + Main.i18n("button.change"));
		removeButton.setHTML(OkmConstants.ICON_DELETE_BUTTON + Main.i18n("button.delete"));
	}
