...
public class OmrPopup extends DialogBox {
	...
	public OmrPopup() {
		...
		executeButton = new Button(OkmConstants.ICON_ADD_BUTTON + Main.i18n("button.execute"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
				process();
			}
	...
	public void langRefresh() {
		...
		executeButton.setHTML(OkmConstants.ICON_ADD_BUTTON + Main.i18n("button.execute"));
