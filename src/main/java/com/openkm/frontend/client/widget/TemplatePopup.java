...
public class TemplatePopup extends DialogBox {
	...
	public TemplatePopup() {
		...
		// Buttons
		cancel = new Button(OkmConstants.ICON_NO_BUTTON + Main.i18n("button.cancel"));
		...
		create = new Button(OkmConstants.ICON_ADD_BUTTON + Main.i18n("button.create"));
	...
	public void langRefresh() {
		...
		create.setHTML(OkmConstants.ICON_ADD_BUTTON + Main.i18n("button.create"));
