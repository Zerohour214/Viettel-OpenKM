...
public class WorkflowDashboard extends Composite {
	...
	public WorkflowDashboard() {
		...
		pendingTasks = new WorkflowWidget("dashboard.workflow.pending.tasks", "glyphicons glyphicons-cogwheels", true);
		pendingPooledTasks = new WorkflowWidget("dashboard.workflow.pending.tasks.unassigned", "glyphicons glyphicons-cogwheel", true);
