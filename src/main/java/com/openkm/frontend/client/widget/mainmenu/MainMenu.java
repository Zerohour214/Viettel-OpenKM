...
public class MainMenu extends Composite {
	...
	public MainMenu() {
		...
		findFolder = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-folder-open", Main.i18n("general.menu.file.find.folder")), true,
				findFolderOKM);
		findFolder.addStyleName("okm-MainMenuItem");
		findDocument = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-file", Main.i18n("general.menu.file.find.document")),
				true, findDocumentOKM);
		findDocument.addStyleName("okm-MainMenuItem");
		findSimilarDocument = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-sort",
		...
		createFolder = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-folder-plus", Main.i18n("general.menu.file.create.directory")),
				true, createFolderOKM);
		createFolder.addStyleName("okm-MainMenuItem");
		addDocument = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-file-plus", Main.i18n("general.menu.file.add.document")), true,
				addDocumentOKM);
		addDocument.addStyleName("okm-MainMenuItem");
		addVOffice = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-file-cloud", Main.i18n("general.menu.file.add.voffice")), true,
				addVOfficeOKM);
		addVOffice.addStyleName("okm-MainMenuItem");
		download = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-download-alt", Main.i18n("general.menu.file.download.document")), true,
				downloadOKM);
		download.addStyleName("okm-MainMenuItem");
		downloadPdf = new MenuItem(
				Util.menuHTMLWithGlyphicon("glyphicons glyphicons-file-cloud-download", Main.i18n("general.menu.file.download.document.pdf")), true,
				downloadPdfOKM);
		downloadPdf.addStyleName("okm-MainMenuItem");
		sendDocumentLink = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-random", Main.i18n("general.menu.file.send.link")),
				true, sendDocumentLinkOKM);
		sendDocumentLink.addStyleName("okm-MainMenuItem");
		sendDocumentAttachment = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-file-export",
		...
		forwardMail = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-message-new", Main.i18n("general.menu.file.send.forward.mail")), true,
				sendMailForwardOKM);
		forwardMail.addStyleName("okm-MainMenuItem");
		createFromTemplate = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-article",
		...
		export = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-cargo", Main.i18n("general.menu.file.export")), true, exportToFile);
		...
		startWorkflow = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-cogwheels", Main.i18n("general.menu.file.start.workflow")),
		...
		refresh = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-refresh", Main.i18n("general.menu.file.refresh")), true, refreshOKM);
		...
		restore = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-roundabout", Main.i18n("general.menu.file.restore")), true, restoreOKM);
		restore.addStyleName("okm-MainMenuItem");
		purge = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-warning-sign", Main.i18n("general.menu.file.purge")), true, purgeOKM);
		purge.addStyleName("okm-MainMenuItem");
		purgeTrash = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-bin", Main.i18n("general.menu.file.purge.trash")), true,
				purgeTrashOKM);
		...
		exit = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-exit", Main.i18n("general.menu.file.exit")), true, exitOKM);
		...
		subMenuFile.addItem(addVOffice);
		...
		// Edit menu
		// First we must create menus and submenus on inverse order
		lock = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-lock", Main.i18n("general.menu.edit.lock")), true, lockOKM);
		lock.addStyleName("okm-MainMenuItem");
		unlock = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-unlock", Main.i18n("general.menu.edit.unlock")), true, unlockOKM);
		...
		checkout = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-pencil", Main.i18n("general.menu.edit.checkout")), true, checkoutOKM);
		checkout.addStyleName("okm-MainMenuItem");
		checkin = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-ok", Main.i18n("general.menu.edit.checkin")), true, checkinOKM);
		checkin.addStyleName("okm-MainMenuItem");
		cancelCheckout = new MenuItem(
				Util.menuHTMLWithGlyphicon("glyphicons glyphicons-remove", Main.i18n("general.menu.edit.cancel.checkout")), true,
				cancelCheckoutOKM);
		...
		delete = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-bin", Main.i18n("general.menu.edit.delete")), true, deleteOKM);
		delete.addStyleName("okm-MainMenuItem");
		copy = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-duplicate", Main.i18n("general.menu.edit.copy")), true, copyOKM);
		copy.addStyleName("okm-MenuItem-strike");
		move = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-copy", Main.i18n("general.menu.edit.move")), true, moveOKM);
		move.addStyleName("okm-MenuItem-strike");
		rename = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-text-color", Main.i18n("general.menu.edit.rename")), true, renameOKM);
		rename.addStyleName("okm-MenuItem-strike");
		note = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-notes", Main.i18n("general.menu.edit.add.note")), true, addNote);
		note.addStyleName("okm-MenuItem-strike");
		category = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-table", Main.i18n("category.add")), true, addCategory);
		category.addStyleName("okm-MenuItem-strike");
		keyword = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-font", Main.i18n("keyword.add")), true, addKeyword);
		keyword.addStyleName("okm-MenuItem-strike");
		merge = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-resize-small", Main.i18n("general.menu.edit.merge.pdf")), true, mergePdf);
		...
		addPropertyGroup = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-plus",
				Main.i18n("general.menu.edit.add.property.group")), true, addPropertyGroupOKM);
		addPropertyGroup.addStyleName("okm-MenuItem-strike");
		updatePropertyGroup = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-ok-sign",
		...
		removePropertyGroup = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-minus",
		...
		addSubscription = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-message-plus",
				Main.i18n("general.menu.edit.add.subscription")), true, addSubscriptionOKM);
		addSubscription.addStyleName("okm-MenuItem-strike");
		removeSubscription = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-message-minus",
		...
		// Submenu language
		language = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-global", Main.i18n("general.menu.tools.languages")), true,
				subMenuLanguage);
		...
		skinDefault = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-text-smaller", Main.i18n("general.menu.tools.skin.default")), true,
				setSkinDefault);
		skinMediumFont = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-text-bigger", Main.i18n("general.menu.tools.skin.mediumfont")), true,
				setSkinMediumFont);
		skinBigFont = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-text-width", Main.i18n("general.menu.tools.skin.bigfont")), true,
				setSkinBigFont);
		...
		// Submenu skin
		skin = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-text-height", Main.i18n("general.menu.tools.skin")), true, subMenuSkin);
		skin.addStyleName("okm-MainMenuItem");

		// Other tools options
		debugConsole = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-embed-close", Main.i18n("general.menu.tools.debug.console")), true,
				setViewDebugConsole);
		debugConsole.addStyleName("okm-MainMenuItem");
		administration = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-old-man", Main.i18n("general.menu.tools.administration")),
		...
		userPreferences = new MenuItem(
				Util.menuHTMLWithGlyphicon("glyphicons glyphicons-user", Main.i18n("general.menu.tools.user.preferences")), true,
				setUserPreferences);
		userPreferences.addStyleName("okm-MainMenuItem");
		subMenuPreferences.addItem(userPreferences);

		// Submenu preferences
		preferences = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-wrench", Main.i18n("general.menu.tools.preferences")), true,
				subMenuPreferences);
		preferences.addStyleName("okm-MainMenuItem");

		// OMR
		omr = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-list-alt", Main.i18n("general.menu.tools.omr")), true, executeOmr);
		omr.addStyleName("okm-MainMenuItem");

		// Convert
		convert = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-move-square", Main.i18n("general.menu.tools.convert")), true, showConvert);
		...
		home = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-home", Main.i18n("general.menu.bookmark.home")), true, goToUserHome);
		home.addStyleName("okm-MainMenuItem");
		defaultHome = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-list", Main.i18n("general.menu.bookmark.default.home")), true,
				setDefaultHome);
		defaultHome.addStyleName("okm-MainMenuItem");
		addBookmark = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-bookmark", Main.i18n("general.menu.bookmark.add")), true,
				addBookmarkOKM);
		addBookmark.addStyleName("okm-MainMenuItem");
		manageBookmark = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-log-book", Main.i18n("general.menu.bookmark.edit")), true,
				editBookmark);
		...
		documentation = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-file",
		...
		bugReport = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-bug",
		...
		supportRequest = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-question-sign",
		...
		publicForum = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-conversation",
		...
		versionChanges = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-sound-5-1",
		...
		projectWeb = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-home",
		...
		about = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-star", Main.i18n("general.menu.help.about")), true, aboutOKM);
	...
	public void langRefresh() {
		...
		findFolder.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-folder-open", Main.i18n("general.menu.file.find.folder")));
		findDocument.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-file", Main.i18n("general.menu.file.find.document")));
		findSimilarDocument
				.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-sort", Main.i18n("general.menu.file.find.similar.document")));
		createFolder.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-folder-plus", Main.i18n("general.menu.file.create.directory")));
		download.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-download-alt", Main.i18n("general.menu.file.download.document")));
		downloadPdf.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-file-cloud-download", Main.i18n("general.menu.file.download.document.pdf")));
		sendDocumentLink.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-random", Main.i18n("general.menu.file.send.link")));
		sendDocumentAttachment.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-file-export",
				Main.i18n("general.menu.file.send.attachment")));
		forwardMail.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-message-new", Main.i18n("general.menu.file.send.forward.mail")));
		createFromTemplate.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-article",
				Main.i18n("general.menu.file.create.from.template")));
		export.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-cargo", Main.i18n("general.menu.file.export")));
		startWorkflow.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-cogwheels", Main.i18n("general.menu.file.start.workflow")));
		refresh.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-refresh", Main.i18n("general.menu.file.refresh")));
		restore.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-roundabout", Main.i18n("general.menu.file.restore")));
		purge.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-warning-sign", Main.i18n("general.menu.file.purge")));
		purgeTrash.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-bin", Main.i18n("general.menu.file.purge.trash")));
		exit.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-exit", Main.i18n("general.menu.file.exit")));
		menuEdit.setText(Main.i18n("general.menu.edit"));
		lock.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-lock", Main.i18n("general.menu.edit.lock")));
		unlock.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-unlock", Main.i18n("general.menu.edit.unlock")));
		addDocument.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-file-plus", Main.i18n("general.menu.file.add.document")));
		addVOffice.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-file-cloud", Main.i18n("general.menu.file.add.voffice")));
		checkout.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-pencil", Main.i18n("general.menu.edit.checkout")));
		checkin.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-ok", Main.i18n("general.menu.edit.checkin")));
		cancelCheckout.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-remove", Main.i18n("general.menu.edit.cancel.checkout")));
		delete.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-bin", Main.i18n("general.menu.edit.delete")));
		move.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-copy", Main.i18n("general.menu.edit.move")));
		copy.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-duplicate", Main.i18n("general.menu.edit.copy")));
		rename.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-text-color", Main.i18n("general.menu.edit.rename")));
		note.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-notes", Main.i18n("general.menu.edit.add.note")));
		category.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-table", Main.i18n("category.add")));
		keyword.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-font", Main.i18n("keyword.add")));
		merge.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-resize-small", Main.i18n("general.menu.edit.merge.pdf")));
		addPropertyGroup
				.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-plus", Main.i18n("general.menu.edit.add.property.group")));
		updatePropertyGroup.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-ok-sign",
				Main.i18n("general.menu.edit.update.property.group")));
		removePropertyGroup.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-minus",
				Main.i18n("general.menu.edit.remove.property.group")));
		addSubscription.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-message-plus", Main.i18n("general.menu.edit.add.subscription")));
		removeSubscription.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-message-minus",
				Main.i18n("general.menu.edit.remove.subscription")));
		menuTools.setText(Main.i18n("general.menu.tools"));
		language.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-global", Main.i18n("general.menu.tools.languages")));
		skin.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-text-height", Main.i18n("general.menu.tools.skin")));
		skinDefault.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-text-smaller", Main.i18n("general.menu.tools.skin.default")));
		skinMediumFont.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-text-bigger", Main.i18n("general.menu.tools.skin.mediumfont")));
		...
		convert.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-move-square", Main.i18n("general.menu.tools.convert")));
		menuBookmark.setText(Main.i18n("general.menu.bookmark"));
		home.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-home", Main.i18n("general.menu.bookmark.home")));
		defaultHome.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-list", Main.i18n("general.menu.bookmark.default.home")));
		addBookmark.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-bookmark", Main.i18n("general.menu.bookmark.add")));
		manageBookmark.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-log-book", Main.i18n("general.menu.bookmark.edit")));
		...
		documentation.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-file",
				Util.windowOpen(Main.i18n("general.menu.help.documentation"), URI_DOCUMENTATION)));
		bugReport.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-bug",
				Util.windowOpen(Main.i18n("general.menu.help.bug.report"), URI_BUG_REPORT)));
		supportRequest.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-question-sign",
				Util.windowOpen(Main.i18n("general.menu.help.support.request"), URI_SUPPORT_REQUEST)));
		publicForum.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-conversation",
				Util.windowOpen(Main.i18n("general.menu.help.public.forum"), URI_PUBLIC_FORUM)));
		versionChanges.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-sound-5-1",
				Util.windowOpen(Main.i18n("general.menu.help.version.changes"), URI_VERSION_CHANGES)));
		projectWeb.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-home",
				Util.windowOpen(Main.i18n("general.menu.help.project.web"), URI_PROJECT_WEB)));
		about.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-star", Main.i18n("general.menu.help.about")));
	}
	...
	Command addVOfficeOKM = new Command() {
		@Override
		public void execute() {
			if (mainMenuOption.addDocumentOption) {
				Main.get().mainPanel.topPanel.toolBar.executeAddVOffice();
			}
		}
	};
	...
	public void setAvailableOption(GWTWorkspace workspace) {
		...
		addVOffice.setVisible(option.isAddDocumentOption());
	...
	private void createSubMenu(String parentFolderPath, String fldName) {
		...
		MenuItem menuFolder = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-folder-open icon-green-renew", fldName), true, subMenuFolder);
