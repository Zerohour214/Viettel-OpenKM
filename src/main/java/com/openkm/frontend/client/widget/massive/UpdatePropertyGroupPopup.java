...
public class UpdatePropertyGroupPopup extends DialogBox implements HasPropertyHandler, ValidatorToFire {
	...
	public UpdatePropertyGroupPopup() {
		...
		addGroup = new Button(OkmConstants.ICON_ADD_BUTTON + Main.i18n("search.add.property.group"));
		...
		addGroup.addStyleName("btn");
		addGroup.addStyleName("btn-success");
		...
		// buttons
		updateButton = new Button(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.update"));
	...
	public void langRefresh() {
		setText(Main.i18n("group.update.label"));
		addGroup.setHTML(OkmConstants.ICON_ADD_BUTTON + Main.i18n("search.add.property.group"));
