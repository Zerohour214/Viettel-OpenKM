...
public class FindDocumentSelectPopup extends DialogBox {
	...
	public FindDocumentSelectPopup() {
		...
		actionButton = new Button(OkmConstants.ICON_YES_BUTTON + Main.i18n("search.result.menu.go.document"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
		...
		documentTable.addStyleName("okm-doc-search-result-renew");
	...
	public void langRefresh() {
		...
		actionButton.setHTML(OkmConstants.ICON_YES_BUTTON + Main.i18n("search.result.menu.go.document"));
	}
