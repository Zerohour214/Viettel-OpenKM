...
public class FileUploadPopup extends DialogBox {
	...
	public FileUploadPopup() {
		...
		closeButton = new Button(OkmConstants.ICON_NO_BUTTON + Main.i18n("fileupload.button.close"), new ClickHandler() {
			@Override
		...
		addButton = new Button(OkmConstants.ICON_ADD_BUTTON + Main.i18n("fileupload.button.add.other.file"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
		...
		sendButton.setHTML(OkmConstants.ICON_ADD_BUTTON + Main.i18n("fileupload.button.send"));
...
//            			}
	...
	public void langRefresh() {
		...
		addButton.setHTML(OkmConstants.ICON_ADD_BUTTON + Main.i18n("fileupload.button.add.other.file"));
		sendButton.setHTML(OkmConstants.ICON_ADD_BUTTON + Main.i18n("fileupload.button.send"));
