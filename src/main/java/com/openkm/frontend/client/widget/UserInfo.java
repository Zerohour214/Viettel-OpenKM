...
public class UserInfo extends Composite {
	...
	private HorizontalPanel panel3;
	private Image advertisement;
	private HTML user;
	private HTML img;
	private HTML userRepositorySize;
	private HTML imgRepositorySize;
	private HTML lockedDocuments;
	private HTML imgLockedDocuments;
	private HTML checkoutDocuments;
	private HTML imgCheckoutDocuments;
	private HTML subscriptions;
	private HTML imgSubscriptions;
	private HTML newDocuments;
	private HTML imgNewsDocuments;
	private HTML newWorkflowTasks;
	private HTML imgWorkflowTasks;
	private HTML newWorkflowPooledTasks;
	private HTML imgWorkflowPooledTasks;
	private HTML imgChat;
	private HTML imgNewChatRoom;
	...
	public UserInfo() {
		...
		img = new HTML("<span class=\"glyphicons glyphicons-resize-small icon-white-renew wide-padding-footer\"></span>");
		...
		imgRepositorySize = new HTML("<span class=\"glyphicons glyphicons-server icon-white-renew wide-padding-footer\"></span>");
		imgUserQuota = new Image(OKMBundleResources.INSTANCE.quota1());
		imgChat = new HTML("<span class=\"glyphicons glyphicons-user-conversation icon-red-renew wide-padding-footer\"></span>");
		imgChatSeparator = new Image(OKMBundleResources.INSTANCE.separator());
		imgNewChatRoom = new HTML("<span class=\"glyphicons glyphicons-conversation icon-white-renew wide-padding-footer\"></span>");
		imgLockedDocuments = new HTML("<span class=\"glyphicons glyphicons-folder-lock icon-white-renew wide-padding-footer\"></span>");
		imgCheckoutDocuments = new HTML("<span class=\"glyphicons glyphicons-pencil icon-white-renew wide-padding-footer\"></span>");
		imgSubscriptions = new HTML("<span class=\"glyphicons glyphicons-message-plus icon-white-renew wide-padding-footer\"></span>");
		imgNewsDocuments = new HTML("<span class=\"glyphicons glyphicons-info-sign icon-white-renew wide-padding-footer\"></span>");
		imgWorkflowTasks = new HTML("<span class=\"glyphicons glyphicons-cogwheel icon-white-renew wide-padding-footer\"></span>");
		imgWorkflowPooledTasks = new HTML("<span class=\"glyphicons glyphicons glyphicons-tag icon-white-renew wide-padding-footer\"></span>");
	...
	public void setUserRepositorySize(double size) {
		...
		userRepositorySize.setHTML("<div class=\"white-text\">&nbsp;" + Util.formatSize(size) + "&nbsp;</div>");
		if (userQuota) {
			if (size > 0) {
				if (size >= quotaLimit) {
					quotaExceeded = true;
	...
	public void setLockedDocuments(int value) {
		lockedDocuments.setHTML("<div class=\"white-text\">&nbsp;" + value + "&nbsp;</div>");
	}
	...
	public void setCheckoutDocuments(int value) {
		checkoutDocuments.setHTML("<div class=\"white-text\">&nbsp;" + value + "&nbsp;</div>");
	}
	...
	public void setSubscriptions(int value) {
		subscriptions.setHTML("<div class=\"white-text\">&nbsp;" + value + "&nbsp;</div>");
	}
	...
	public void setNewsDocuments(int value) {
		newDocuments.setHTML("<div class=\"white-text\">&nbsp;" + value + "&nbsp;</div>");
		if (value > 0) {
			imgNewsDocuments.setHTML("<span class=\"glyphicons glyphicons-exclamation-sign icon-white-renew wide-padding-footer\"></span>");
		} else {
			imgNewsDocuments.setHTML("<span class=\"glyphicons glyphicons-info-sign icon-white-renew wide-padding-footer\"></span>");
		}
	}
	...
	public void setNewsWorkflows(int value) {
		newWorkflowTasks.setHTML("<div class=\"white-text\">&nbsp;" + value + "&nbsp;</div>");

		if (value > 0) {
			imgWorkflowTasks.setHTML("<span class=\"glyphicons glyphicons-cogwheels icon-white-renew wide-padding-footer\"></span>");
		} else {
			imgWorkflowTasks.setHTML("<span class=\"glyphicons glyphicons-cogwheel icon-white-renew wide-padding-footer\"></span>");
		}
	}
	...
	public void setPooledTaskInstances(int value) {
		newWorkflowPooledTasks.setHTML("<div class=\"white-text\">&nbsp;" + value + "&nbsp;<div>");

		if (value > 0) {
			imgWorkflowPooledTasks.setHTML("<span class=\"glyphicons glyphicons glyphicons-tags icon-white-renew wide-padding-footer\"></span>");
		} else {
			imgWorkflowPooledTasks.setHTML("<span class=\"glyphicons glyphicons glyphicons-tag icon-white-renew wide-padding-footer\"></span>");
		}
	}
	...
	public void langRefresh() {
		...
		user.setHTML("<div class=\"white-text\">&nbsp;" + Main.i18n("general.connected") + " " + usr + "&nbsp;</div>");
	...
	public void disconnectChat() {
		...
		imgNewChatRoom.setVisible(false);
		usersConnected.setHTML("");
		imgChat.setHTML("<span class=\"glyphicons glyphicons-user-conversation icon-red-renew wide-padding-footer\"></span>");
	}
			...
			public void onSuccess(List<GWTUser> result) {
				...
				if (logged) {
					...
					chatService.login(new AsyncCallback<Object>() {
						...
						public void onSuccess(Object result) {
							chatConnected = true;
							imgChat.setHTML("<span class=\"glyphicons glyphicons-user-conversation icon-green-renew wide-padding-footer\"></span>");
							imgChat.setTitle(Main.i18n("user.info.chat.disconnect"));
