...
public class TrashMenu extends MenuBase {
	...
	public TrashMenu() {
		...
		restoreItem = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-roundabout", Main.i18n("general.menu.file.restore")), true, restore);
		restoreItem.addStyleName("okm-MenuItem");
		dirMenu.addItem(restoreItem);
		purgeItem = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-warning-sign", Main.i18n("general.menu.file.purge")), true, purge);
	...
	public void langRefresh() {
		restoreItem.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-roundabout", Main.i18n("general.menu.file.restore")));
		purgeItem.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-warning-sign", Main.i18n("general.menu.file.purge")));
	}
