...
public class NotifyPopup extends DialogBox {
	...
	public NotifyPopup() {
		...
		sendButton = new Button(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.send"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
	...
	public void langRefresh() {
		...
		sendButton.setHTML(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.send"));
		commentTXT = new HTML("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + Main.i18n("fileupload.label.notify.comment"));
