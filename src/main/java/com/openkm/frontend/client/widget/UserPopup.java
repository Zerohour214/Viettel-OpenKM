...
public class UserPopup extends DialogBox implements ClickHandler {
	...
	public UserPopup() {
		...
		acceptButton = new Button(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.accept"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
				...
				if (!userPasswordText.getText().equals(userPasswordTextVerify.getText())) {
					...
					String mailAdd = userMailText.getText();
					String regex  = "^[\\w!#$%&'*+/=?`{|}~^-]+(?:\\.[\\w!#$%&'*+/=?`{|}~^-]+)*@(?:[a-zA-Z0-9-]+\\.)+[a-zA-Z]{2,6}$";
					// First must validate password
					workspaceService.isValidForm(userPasswordText.getText(), mailAdd, new AsyncCallback<String>() {
						@Override
		...
		cancelButton = new Button(OkmConstants.ICON_NO_BUTTON + Main.i18n("button.cancel"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
				hide();
			}
		...
		testButton = new Button(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.test"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
				mailTestError.setVisible(false);
				mailTestOK.setVisible(false);
		...
		deleteButton = new Button(OkmConstants.ICON_DELETE_BUTTON + Main.i18n("button.delete"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
		...
		deleteButton.addStyleName("btn-danger");
		testButton.setStyleName("okm-YesButton");
		testButton.addStyleName("btn");
		testButton.addStyleName("btn-success");
	...
	public void langRefresh() {
		...
		acceptButton.setHTML(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.accept"));
		cancelButton.setHTML(OkmConstants.ICON_NO_BUTTON + Main.i18n("button.cancel"));
		deleteButton.setHTML(OkmConstants.ICON_DELETE_BUTTON + Main.i18n("button.delete"));
		testButton.setHTML(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.test"));
		userGroupBoxPanel.setCaption(Main.i18n("user.preferences.user.data"));
		mailGroupBoxPanel.setCaption(Main.i18n("user.preferences.mail.data"));
	}
