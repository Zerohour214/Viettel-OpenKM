...
public class SearchAdvanced extends Composite {
	...
	public TextBox path;
	public HTML pathExplorer;
	public HTML pathClean;
	public HTML categoryExplorer;
	public HTML categoryClean;
	...
	public SearchAdvanced() {
		...
		pathExplorer = new HTML("<span class=\"glyphicons glyphicons-folder-open icon-green-renew\" style =\"padding-left: 5px;\" ></span>");
		pathClean = new HTML("<span class=\"glyphicons glyphicons-remove-sign icon-red-renew\" style =\"padding-left: 5px;\"></span>");
		...
		pathExplorerPanel.setCellVerticalAlignment(pathClean, HasAlignment.ALIGN_MIDDLE);

		// Sets the category explorer
		categoryExplorerPanel = new HorizontalPanel();
		categoryUuid = "";
		categoryPath = new TextBox();
		categoryPath.setWidth("380px");
		categoryPath.setReadOnly(true);
		categoryExplorer = new HTML("<span class=\"glyphicons glyphicons-folder-open icon-green-renew\" style =\"padding-left: 5px;\" ></span>");
		categoryClean = new HTML("<span class=\"glyphicons glyphicons-remove-sign icon-red-renew\" style =\"padding-left: 5px;\"></span>");
		...
		categoryExplorerPanel.setCellVerticalAlignment(categoryClean, HasAlignment.ALIGN_MIDDLE);
		...
		table.getElement().setAttribute("style","padding: 5px 29px 18px 40px");
		...
		tableMail.getElement().setAttribute("style","background-color: #e5e5e9");
		tableMail.setVisible(false);
		...
		from.addStyleName("okm-advancedSearch-mail-renew");
		to.setStyleName("okm-Input");
		to.addStyleName("okm-advancedSearch-mail-renew");
		subject.setStyleName("okm-Input");
		subject.addStyleName("okm-advancedSearch-mail-renew");
		mimeTypes.setStyleName("okm-Select");
		mimeTypes.addStyleName("okm-Input");
		mimeTypes.getElement().setAttribute("style","width: 380px; box-sizing: border-box;");
		typeDocument.addStyleName("okm-checkbox-distance-renew");
		typeFolder.addStyleName("okm-checkbox-distance-renew");
		typeMail.addStyleName("okm-checkbox-distance-renew");
