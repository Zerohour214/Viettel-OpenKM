...
public class FancyFileUpload extends Composite implements HasText, HasChangeHandlers {
	...
	FlexTable vtTable = new FlexTable();
	...
	private TextBox docCode = new TextBox();
	private Label docCodeLabel = new Label();
	private TextBox docName = new TextBox();
	private Label docNameLabel = new Label();
	private DateBox docEffectiveDate = new DateBox();
	private Label docEffectiveDateLabel = new Label();
	private Label docOrgLabel = new Label();
	private ListBox orgListBox = new ListBox();
	private Label docConfidentialityLabel = new Label();
	private ListBox docConfidentialityListBox = new ListBox();

	private Label docExpiredDateLabel = new Label();
	private DateBox docExpiredDate = new DateBox();
	private Label publishComLabel = new Label();
	private TextBox publishCom = new TextBox();
	private Label docAuthorLabel = new Label();
	private TextBox docAuthor = new TextBox();
	private Label pageNumberLabel = new Label();
	private TextBox  pageNumber = new TextBox();
	private Label publishedYearLabel = new Label();
	...
	protected class UploadDisplay extends Composite {
		...
		public UploadDisplay() {
			...
			hPBPanel.setCellHorizontalAlignment(progressBar, HasAlignment.ALIGN_CENTER);
			...
			mainPanel.setCellHorizontalAlignment(pendingPanel, HorizontalPanel.ALIGN_CENTER);
		...
		private void reset(boolean enableImport, boolean enableNotifyButton) {
			...
			docCode.setText("");
			docName.setText("");
			docEffectiveDate.setValue(null);
			docExpiredDate.setValue(null);
			docAuthor.setText("");
			publishCom.setText("");
		...
		public void resetWhileUploading(boolean enableImport, boolean enableNotifyButton) {
			...
			docName.setText("");
			docEffectiveDate.setValue(null);
			orgListBox.setSelectedIndex(0);
			docConfidentialityListBox.setSelectedIndex(0);
			docExpiredDate.setValue(null);
			docAuthor.setText("");
			publishCom.setText("");
			publishedYear.setText("");
	...
	private void uploadFiles() {
		...
		uploadForm.setDocCode(docCode.getText());
		uploadForm.setDocName(docName.getText());
		uploadForm.setDocEffectiveDate(docEffectiveDate.getValue());
		uploadForm.setDocOrg(orgListBox.getSelectedValue());
		uploadForm.setDocConfidentiality(docConfidentialityListBox.getSelectedValue());
		uploadForm.setDocExpiredDate(docExpiredDate.getValue());
		uploadForm.setDocAuthor(docAuthor.getText());
		uploadForm.setPublishCom(publishCom.getText());
		uploadForm.setPublishedYear(publishedYear.getText());
		uploadForm.setPageNumber(pageNumber.getText());
	...
	public FancyFileUpload() {
		...
		docCode = new TextBox();
		docCode.setMaxLength(255);
		docCode.setName("docCode");
		docCode.setVisible(true);
		docCode.setWidth("200px");
		docCode.setStyleName("okm-TextArea");
		docCodeLabel.setText(Main.i18n("document.code"));
		docCodeLabel.setWidth("150px");
		vtTable.setWidget(0, 0, docCodeLabel);
		vtTable.setWidget(0, 1, docCode);

		vtTable.setWidget(0, 2, new HTML(""));
		HTMLTable.CellFormatter cellFormatter = vtTable.getCellFormatter();
		...
		docName.setWidth("200px");
		docName.setStyleName("okm-TextArea");
		docNameLabel.setText(Main.i18n("document.docName"));
		docNameLabel.setWidth("150x");
		vtTable.setWidget(0, 3, docNameLabel);
		vtTable.setWidget(0, 4, docName);
		...
		docEffectiveDate.setVisible(true);
		docEffectiveDate.setWidth("200px");
		docEffectiveDateLabel.setText(Main.i18n("document.effectiveDate"));
		docEffectiveDateLabel.setWidth("150px");
		docEffectiveDate.setFormat(new DateBox.DefaultFormat(dateFormat));
		docEffectiveDate.getDatePicker().setYearArrowsVisible(true);
		vtTable.setWidget(1, 0, docEffectiveDateLabel);
		vtTable.setWidget(1, 1, docEffectiveDate);

		docExpiredDate.getTextBox().setName("docExpiredDate");
		docExpiredDate.setVisible(true);
		docExpiredDate.setWidth("200px");
		docExpiredDateLabel.setText("Ngày hết hạn");
		docExpiredDateLabel.setWidth("150px");
		docExpiredDate.setFormat(new DateBox.DefaultFormat(dateFormat));
		docExpiredDate.getDatePicker().setYearArrowsVisible(true);
		...
		docConfidentialityListBox.setVisible(true);
		docConfidentialityListBox.setWidth("200px");
		docConfidentialityLabel.setText(Main.i18n("document.confidentiality.level"));
		docConfidentialityLabel.setWidth("150px");
		vtTable.setWidget(2, 3, docConfidentialityLabel);
		vtTable.setWidget(2, 4, docConfidentialityListBox);

		docAuthor.setName("docAuthor");
		docAuthor.setVisible(true);
		docAuthor.setWidth("200px");
		...
		publishCom.setWidth("200px");
		publishCom.setStyleName("okm-TextArea");
		publishComLabel.setText(Main.i18n("document.publishCom"));
		publishComLabel.setWidth("150px");
		vtTable.setWidget(3, 3, publishComLabel);
		vtTable.setWidget(3, 4, publishCom);

		publishedYear.setName("publishedYear");
		publishedYear.setVisible(true);
		publishedYear.setWidth("200px");
		publishedYear.setStyleName("okm-TextArea");
		publishedYear.addKeyPressHandler(new KeyPressHandler() {
			@Override
		...
		vtTable.setWidth("700");
		mainPanel.add(vtTable);
		...
		// Initialize confidentiality levels
	...
	public void getAllConfidentialityLevels() {
	...
	public void uploadNewPendingFile() {
		...
		if (!filesToUpload.isEmpty()) {
			...
			actualFileToUpload.getUploadForm().setDocCode(docCode.getText());
			actualFileToUpload.getUploadForm().setDocName(docName.getText());
			actualFileToUpload.getUploadForm().setDocEffectiveDate(docEffectiveDate.getValue());
			actualFileToUpload.getUploadForm().setDocOrg(orgListBox.getSelectedValue());
			actualFileToUpload.getUploadForm().setDocConfidentiality(docConfidentialityListBox.getSelectedValue());
