...
public class CategoriesMenu extends MenuBase {
	...
	public CategoriesMenu() {
		...
		cancelCheckout = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-remove", Main.i18n("filebrowser.menu.checkout.cancel")),
		...
		propertyGroup = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-plus",
