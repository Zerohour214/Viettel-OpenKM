...
public class PdfMergePopup extends DialogBox {
	...
	public PdfMergePopup() {
		...
		merge = new Button(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.merge"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
				merge();
			}
		...
		merge.addStyleName("btn");
		merge.addStyleName("btn-success");
	...
	public void langRefresh() {
		...
		merge.setHTML(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.merge"));
