...
public class SecurityPopup extends DialogBox {
	...
	public SecurityPopup() {
		...
		change = new Button(OkmConstants.ICON_EDIT_BUTTON + Main.i18n("button.change"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
		...
		change.addStyleName("btn");
		change.addStyleName("btn-success");
	...
	public void langRefresh() {
		...
		close.setHTML(OkmConstants.ICON_NO_BUTTON + Main.i18n("button.close"));
		change.setHTML(OkmConstants.ICON_EDIT_BUTTON + Main.i18n("button.change"));
