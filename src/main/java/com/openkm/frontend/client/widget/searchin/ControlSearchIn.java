...
public class ControlSearchIn extends Composite {
	...
	public ControlSearchIn() {
		...
		previous = new HTML("<span class=\"glyphicons glyphicons-play flip-horizontal-glyphicon icon-green-renew\"></span>");
		next = new HTML("<span class=\"glyphicons glyphicons-play icon-green-renew\"></span>");;
		export = new HTML("<span class=\"glyphicons glyphicons-file-export icon-green-renew\"></span>");
	...
	public void evaluateIcons() {
		if (previousEnabled) {
			previous.setHTML("<span class=\"glyphicons glyphicons-play flip-horizontal-glyphicon icon-green-renew\"></span>");
		} else {
			previous.setHTML("<span class=\"glyphicons glyphicons-play flip-horizontal-glyphicon icon-disable-renew\"></span>");
		}

		if (nextEnabled) {
			next.setHTML("<span class=\"glyphicons glyphicons-play icon-green-renew\"></span>");
		} else {
			next.setHTML("<span class=\"glyphicons glyphicons-play icon-disable-renew\"></span>");
		}
	}
}