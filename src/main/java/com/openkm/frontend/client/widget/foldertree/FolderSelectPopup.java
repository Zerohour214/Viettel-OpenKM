...
public class FolderSelectPopup extends DialogBox {
	...
	public FolderSelectPopup() {
		...
		contextListBox.addStyleName("okm-Select-folderSelect-renew");
		...
		actionButton = new Button(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.move"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
	...
	public void langRefresh() {
		...
		if (action == ACTION_COPY) {
			actionButton.setHTML(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.copy"));
		} else {
			actionButton.setHTML(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.move"));
		}
	...
	public void setToCreateFromTemplate(GWTDocument document) {
		...
		actionButton.setHTML(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.create"));
	...
	public void setToRestore(GWTDocument document) {
		...
		actionButton.setHTML(OkmConstants.ICON_YES_BUTTON + Main.i18n("button.restore"));
