...
public class TaxonomyMenu extends MenuBase {
	...
	public TaxonomyMenu() {
		...
		download = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-download-alt child-menuitem-glyphicon-renew", Main.i18n("filebrowser.menu.download")), true, downloadFile);
		download.addStyleName("okm-MenuItem-strike");
		dirMenu.addItem(download);
		checkout = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-pencil child-menuitem-glyphicon-renew", Main.i18n("filebrowser.menu.checkout")), true, checkoutFile);
		checkout.addStyleName("okm-MenuItem-strike");
		dirMenu.addItem(checkout);
		checkin = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-ok child-menuitem-glyphicon-renew", Main.i18n("filebrowser.menu.checkin")), true, checkinFile);
		checkin.addStyleName("okm-MenuItem-strike");
		dirMenu.addItem(checkin);
		cancelCheckout = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-remove child-menuitem-glyphicon-renew", Main.i18n("filebrowser.menu.checkout.cancel")), true, cancelCheckoutFile);
		cancelCheckout.addStyleName("okm-MenuItem-strike");
		dirMenu.addItem(cancelCheckout);
		lock = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-lock child-menuitem-glyphicon-renew", Main.i18n("filebrowser.menu.lock")), true, lockFile);
		lock.addStyleName("okm-MenuItem-strike");
		dirMenu.addItem(lock);
		unlock = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-unlock", Main.i18n("filebrowser.menu.unlock")), true, unlockFile);
		unlock.addStyleName("okm-MenuItem-strike");
		dirMenu.addItem(unlock);
		delete = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-bin", Main.i18n("filebrowser.menu.delete")), true, deleteFile);
		delete.addStyleName("okm-MenuItem-strike");
		dirMenu.addItem(delete);
		rename = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-text-color", Main.i18n("general.menu.edit.rename")), true, renameFile);
		rename.addStyleName("okm-MenuItem-strike");
		dirMenu.addItem(rename);
		move = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-copy", Main.i18n("general.menu.edit.move")), true, moveFile);
		move.addStyleName("okm-MenuItem-strike");
		dirMenu.addItem(move);
		copy = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-duplicate", Main.i18n("general.menu.edit.copy")), true, copyFile);
		...
		propertyGroup = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-plus", Main.i18n("general.menu.edit.add.property.group")), true, addPropertyGroup);
		propertyGroup.addStyleName("okm-MenuItem-strike");
		dirMenu.addItem(propertyGroup);
		updatePropertyGroup = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-ok-sign", Main.i18n("general.menu.edit.update.property.group")), true, updatePropertyGroupOKM);
		...
		bookmark = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-bookmark", Main.i18n("general.menu.bookmark.add")), true, addBookmark);
		bookmark.addStyleName("okm-MenuItem-strike");
		dirMenu.addItem(bookmark);
		home = new MenuItem(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-home", Main.i18n("filebrowser.menu.set.home")), true, setHome);
	...
	public void langRefresh() {
		checkout.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-pencil", Main.i18n("filebrowser.menu.checkout")));
		checkin.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-ok", Main.i18n("filebrowser.menu.checkin")));
		delete.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-bin", Main.i18n("filebrowser.menu.delete")));
		rename.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-text-color", Main.i18n("general.menu.edit.rename")));
		cancelCheckout.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-remove", Main.i18n("filebrowser.menu.checkout.cancel")));
		lock.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-lock", Main.i18n("filebrowser.menu.lock")));
		unlock.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-unlock", Main.i18n("filebrowser.menu.unlock")));
		download.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-download-alt", Main.i18n("filebrowser.menu.download")));
		...
		propertyGroup.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-plus", Main.i18n("general.menu.edit.add.property.group")));
		updatePropertyGroup.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-ok-sign", Main.i18n("general.menu.edit.update.property.group")));
		merge.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-resize-small", Main.i18n("general.menu.edit.merge.pdf")));
		bookmark.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-bookmark", Main.i18n("general.menu.bookmark.add")));
		home.setHTML(Util.menuHTMLWithGlyphicon("glyphicons glyphicons-home", Main.i18n("filebrowser.menu.set.home")));
