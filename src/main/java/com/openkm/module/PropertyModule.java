...
public interface PropertyModule {
	...
	public List<String> addListKeyword(String token, String nodePath, List<String> keyword) throws VersionException,
			LockException, PathNotFoundException, AccessDeniedException, RepositoryException,
			DatabaseException;
	/**
	...
	public void updateKeyword(String token, String nodePath) throws VersionException,
			LockException, PathNotFoundException, AccessDeniedException, RepositoryException,
			DatabaseException;
	/**
