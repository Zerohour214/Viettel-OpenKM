...
public class ModuleManager {
	...
	private static OrgModule orgModule = null;
	private static OrgVTXModule orgVTXModule = null;
	...
	public static synchronized OrgModule getOrgModule() {
		if (orgModule == null) {
			if (Config.REPOSITORY_NATIVE) {
				orgModule = new com.openkm.module.db.DbOrgModule();
			} else {
				// Other implementation
			}
		}
	...
	public static synchronized OrgVTXModule getOrgVTXModule() {
		if (orgVTXModule == null) {
			if (Config.REPOSITORY_NATIVE) {
				orgVTXModule = new com.openkm.module.db.DbOrganizationVTXModule();
			} else {
				// Other implementation
			}
		}
	...
	public static synchronized UserModule getUserModule() {
		if (userModule == null) {
			if (Config.REPOSITORY_NATIVE) {
				userModule = new com.openkm.module.db.DbUserModule();
			} else {
				// Other implementation
			}
		}
