...
public class ProfileServlet extends BaseServlet {
	...
	private Profile getUserProfile(HttpServletRequest request) {
		...
		prf.getPrfTab().getPrfDocument().setRelatedVisible(WebUtils.getBoolean(request, "prf_tab_document_related_visible"));
		prf.getPrfTab().getPrfDocument().setActivityVisible(WebUtils.getBoolean(request, "prf_tab_document_activity_visible"));
