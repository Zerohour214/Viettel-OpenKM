...
public class AuthServlet extends BaseServlet {
	...
	private void validatePassword(HttpServletRequest request, HttpServletResponse response) throws ServletException,
		...
		if(value.isEmpty()){
			...
			out.print("{ \"success\": false, \"message\": \"Password contains at least 1 digit, 1 uppercase, 1 lowercase and 1 special. Password length should be between 8 and 20. \" }");
		}
	...
	private void validateEmail(HttpServletRequest request, HttpServletResponse response) throws ServletException,
			IOException, DatabaseException {
		String value = WebUtils.getString(request, "value");
		PrintWriter out = response.getWriter();
		response.setContentType("text/json");
		...
		if (listEmails.contains(value)) {
			out.print("{ \"success\": false, \"message\": \"Email is already exist!\" }");
		} else {
			out.print("{ \"success\": true }");
		}
	...
	private void userCreateByFile(String userId, HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException, BiffException, DatabaseException, AccessDeniedException {
		Part filePart = request.getPart("userFileImport");
