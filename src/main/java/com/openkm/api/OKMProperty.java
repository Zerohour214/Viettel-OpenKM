...
public class OKMProperty implements PropertyModule {
	...
	@Override
	public List<String> addListKeyword(String token, String nodeId, List<String> keywords) throws VersionException, LockException, PathNotFoundException, AccessDeniedException, RepositoryException, DatabaseException {
		log.debug("addKeyword({}, {}, {})", new Object[]{token, nodeId, keywords});
		PropertyModule pm = ModuleManager.getPropertyModule();
		List<String> ret = pm.addListKeyword(token, nodeId, keywords);
		log.debug("addListKeyword: {}", ret);
		return ret;
	}
	...
	public void updateKeyword(String token, String nodePath) throws VersionException, LockException, PathNotFoundException, AccessDeniedException, RepositoryException, DatabaseException {
		...
		PropertyModule pm = ModuleManager.getPropertyModule();
		pm.updateKeyword(token, nodePath);
