...
public class PropertyService implements PropertyModule {
	...
	@Override
	public List<String> addListKeyword(String token, String nodePath, List<String> keyword) throws VersionException, LockException, PathNotFoundException, AccessDeniedException, RepositoryException, DatabaseException {
		log.debug("addListKeyword({}, {}, {})", new Object[]{token, nodePath, keyword});
		PropertyModule pm = ModuleManager.getPropertyModule();
		List<String> ret = pm.addListKeyword(token, nodePath, keyword);
