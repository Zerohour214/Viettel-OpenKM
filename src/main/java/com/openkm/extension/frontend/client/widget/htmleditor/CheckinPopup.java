...
public class CheckinPopup extends DialogBox {
	...
	public CheckinPopup() {
		...
		closeButton = new Button(OkmConstants.ICON_NO_BUTTON + GeneralComunicator.i18n("fileupload.button.close"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
				hide();
			}
		...
		sendButton = new Button("", new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
		...
		sendButton.setHTML(OkmConstants.ICON_ADD_BUTTON + GeneralComunicator.i18n("fileupload.button.send"));
	...
	public void langRefresh() {
		...
		increaseMajorVersion.setHTML(Main.i18n("fileupload.increment.major.version"));
		increaseMinorVersion.setHTML(Main.i18n("fileupload.increment.minor.version"));
		closeButton.setHTML(OkmConstants.ICON_NO_BUTTON + GeneralComunicator.i18n("fileupload.button.close"));
		sendButton.setHTML(OkmConstants.ICON_ADD_BUTTON + GeneralComunicator.i18n("fileupload.button.send"));
