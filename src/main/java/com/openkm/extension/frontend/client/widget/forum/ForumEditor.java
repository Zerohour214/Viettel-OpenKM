...
public class ForumEditor extends Composite {
	...
	public ForumEditor(final ForumController controller) {
		...
		// Create
		create = new Button();
		create.setHTML(OkmConstants.ICON_ADD_BUTTON + GeneralComunicator.i18nExtension("button.create"));
		...
		// Cancel
		cancel = new Button(OkmConstants.ICON_NO_BUTTON + GeneralComunicator.i18n("button.cancel"));
		...
		cancel.addStyleName("btn-warning");

		update = new Button(OkmConstants.ICON_YES_BUTTON + GeneralComunicator.i18n("button.update"));
	...
	public void langRefresh() {
		...
		cancel.setHTML(OkmConstants.ICON_NO_BUTTON + GeneralComunicator.i18n("button.cancel"));
		update.setHTML(OkmConstants.ICON_YES_BUTTON + GeneralComunicator.i18n("button.update"));
		toolbar.langRefresh();
	}
