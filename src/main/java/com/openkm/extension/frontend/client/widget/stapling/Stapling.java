				...
				for (final GWTStapleGroup sg : result) {
					...
					if (sg.getStaples().size() > 0) {
						...
						if (sg.getUser().equals(GeneralComunicator.getUser())) {
							...
							addButton.setHTML(OkmConstants.ICON_ADD_BUTTON + GeneralComunicator.i18nExtension("button.add"));
							...
							Button deleteButton = new Button(OkmConstants.ICON_DELETE_BUTTON + GeneralComunicator.i18n("button.delete"));
