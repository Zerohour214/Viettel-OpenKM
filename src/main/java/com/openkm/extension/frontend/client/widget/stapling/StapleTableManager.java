...
public class StapleTableManager {
	...
	public static void addDocument(FlexTable table, final GWTStaple staple, final String uuid, boolean enableDelete) {
		...
		if (doc.isHasNotes()) {
			table.setHTML(row, 0, table.getHTML(row, 0) + Util.imageItemHTMLIcon("glyphicons glyphicons-note-empty icon-green-renew"));
		}
	...
	public static void addFolder(FlexTable table, final GWTStaple staple, final String uuid, boolean enableDelete) {
		...
		if ((folder.getPermissions() & GWTPermission.WRITE) == GWTPermission.WRITE) {
			if (folder.isHasChildren()) {
				table.setHTML(row, 1, Util.imageItemHTMLIcon("glyphicons glyphicons-folder-new icon-green-renew"));
			} else {
				table.setHTML(row, 1, Util.imageItemHTMLIcon("glyphicons glyphicons-folder-open icon-green-renew"));
			}
		} else {
			if (folder.isHasChildren()) {
				table.setHTML(row, 1, Util.imageItemHTMLIcon("glyphicons glyphicons-folder-new icon-red-renew"));
			} else {
				table.setHTML(row, 1, Util.imageItemHTMLIcon("glyphicons glyphicons-folder-open icon-red-renew"));
			}
		}
