...
public class TabToolbarWiki extends Composite {
	...
	public TabToolbarWiki(final WikiController controller, final boolean isDashboard) {
		...
		// Create
		create = new Button(OkmConstants.ICON_ADD_BUTTON + GeneralComunicator.i18n("button.create"));
		...
		create.addStyleName("btn");
		create.addStyleName("btn-success");
		buttonsPanel.add(create);
		buttonsPanel.add(new HTML("&nbsp;"));
		buttonsPanel.setCellVerticalAlignment(create, HasAlignment.ALIGN_MIDDLE);

		// Edit
		update = new Button(OkmConstants.ICON_EDIT_BUTTON + GeneralComunicator.i18n("button.update"));
		...
		update.addStyleName("btn");
		update.addStyleName("btn-success");
		buttonsPanel.add(update);
		buttonsPanel.add(new HTML("&nbsp;"));
		buttonsPanel.setCellVerticalAlignment(update, HasAlignment.ALIGN_MIDDLE);

		// history
		history = new Button(OkmConstants.ICON_VIEW_BUTTON + GeneralComunicator.i18nExtension("button.history"));
		...
		history.addStyleName("btn");
		history.addStyleName("btn-primary");
		buttonsPanel.add(history);
		buttonsPanel.add(new HTML("&nbsp;"));
		buttonsPanel.setCellVerticalAlignment(history, HasAlignment.ALIGN_MIDDLE);

		// Delete
		delete = new Button(OkmConstants.ICON_DELETE_BUTTON + GeneralComunicator.i18n("button.delete"));
		...
		delete.addStyleName("btn-danger");
		buttonsPanel.add(delete);
		buttonsPanel.add(new HTML("&nbsp;"));
		buttonsPanel.setCellVerticalAlignment(delete, HasAlignment.ALIGN_MIDDLE);

		// unlock
		unlock = new Button(OkmConstants.ICON_EDIT_BUTTON + GeneralComunicator.i18nExtension("button.unlock"));
		...
		unlock.addStyleName("btn");
		unlock.addStyleName("btn-success");
	...
	public void langRefresh() {
		unlock.setHTML(OkmConstants.ICON_EDIT_BUTTON + GeneralComunicator.i18n("button.unlock"));
		if (!isDashboard) {
			home.setHTML(GeneralComunicator.i18nExtension("wiki.current.page"));
		} else {
			home.setHTML(GeneralComunicator.i18nExtension("button.home"));
		}
		create.setHTML(OkmConstants.ICON_ADD_BUTTON + GeneralComunicator.i18n("button.create"));
		update.setHTML(OkmConstants.ICON_EDIT_BUTTON + GeneralComunicator.i18n("button.update"));
		history.setHTML(OkmConstants.ICON_VIEW_BUTTON + GeneralComunicator.i18nExtension("button.history"));
		delete.setHTML(OkmConstants.ICON_DELETE_BUTTON + GeneralComunicator.i18n("button.delete"));
