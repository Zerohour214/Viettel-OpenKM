...
public class DashboardToolbarForum extends Composite {
	...
	public DashboardToolbarForum(final ForumController controller) {
		...
		// New forum
		newForum = new Button();
		newForum.setHTML(OkmConstants.ICON_ADD_BUTTON + GeneralComunicator.i18nExtension("forum.new.forum"));
		...
		newForum.addStyleName("btn");
		newForum.addStyleName("btn-success");
		buttonsPanel.add(newForum);
		buttonsPanel.setCellVerticalAlignment(newForum, HasAlignment.ALIGN_MIDDLE);

		// New topic
		newTopic = new Button();
		newTopic.setHTML(OkmConstants.ICON_ADD_BUTTON + GeneralComunicator.i18nExtension("forum.new.topic"));
		...
		newTopic.addStyleName("btn");
		newTopic.addStyleName("btn-success");
		buttonsPanel.add(newTopic);
		buttonsPanel.setCellVerticalAlignment(newTopic, HasAlignment.ALIGN_MIDDLE);

		// Post reply
		postReply = new Button();
		postReply.setHTML(OkmConstants.ICON_ADD_BUTTON + GeneralComunicator.i18nExtension("forum.post.reply"));
		...
		postReply.addStyleName("btn");
		postReply.addStyleName("btn-success");
