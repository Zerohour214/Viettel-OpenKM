...
public class ProposedSubscriptionReceivedDetail extends Composite {
	...
	public ProposedSubscriptionReceivedDetail() {
		...
		button = new Button(OkmConstants.ICON_YES_BUTTON + GeneralComunicator.i18nExtension("button.subscribe"));
	...
	public void langRefresh() {
		...
		button.setHTML(OkmConstants.ICON_YES_BUTTON + GeneralComunicator.i18nExtension("button.subscribe"));
