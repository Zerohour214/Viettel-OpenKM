...
public class PostEditor extends Composite {
	...
	public PostEditor(final ForumController controller) {
		...
		createButton.setHTML(OkmConstants.ICON_ADD_BUTTON + GeneralComunicator.i18nExtension("button.create"));
		...
		createButton.addStyleName("btn");
		createButton.addStyleName("btn-success");

		// Cancel
		cancelButton = new Button(OkmConstants.ICON_NO_BUTTON + GeneralComunicator.i18n("button.cancel"));
		...
		// update
		acceptButton = new Button(OkmConstants.ICON_YES_BUTTON + GeneralComunicator.i18n("button.accept"));
	...
	public void langRefresh() {
		...
		createButton.setHTML(OkmConstants.ICON_ADD_BUTTON + GeneralComunicator.i18n("button.create"));
