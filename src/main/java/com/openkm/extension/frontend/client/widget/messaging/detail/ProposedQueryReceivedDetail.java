...
public class ProposedQueryReceivedDetail extends Composite {
	 ...
	 * Propose
	 */
	public ProposedQueryReceivedDetail() {
		table = new FlexTable();
		...
		button = new Button(OkmConstants.ICON_YES_BUTTON + GeneralComunicator.i18nExtension("button.accept"));
	...
	final AsyncCallback<Object> callbackShare = new AsyncCallback<Object>() {
		public void onSuccess(Object result) {
			...
			MessagingToolBarBox.get().messageDashboard.messageBrowser.messageDetail.status
					.setFlag_markProposeAsAccepted();
			proposedQueryService.markAccepted(propose.getId(), new AsyncCallback<Object>() {
				@Override
				public void onSuccess(Object result) {
					MessagingToolBarBox.get().messageDashboard.messageBrowser.messageDetail.status
							.unsetFlag_markProposalAsAccepted();
	...
	public void langRefresh() {
		...
		table.setHTML(2, 0, "<b>" + GeneralComunicator.i18nExtension("messaging.detail.query") + "</b>");
		button.setHTML(OkmConstants.ICON_YES_BUTTON + GeneralComunicator.i18nExtension("button.accept"));
