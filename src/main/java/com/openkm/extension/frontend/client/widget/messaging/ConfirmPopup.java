...
public class ConfirmPopup extends DialogBox {
	...
	public ConfirmPopup() {
		...
		cancelButton = new Button(OkmConstants.ICON_NO_BUTTON + GeneralComunicator.i18nExtension("button.cancel"), new ClickHandler() {
			@Override
		...
		acceptButton = new Button(OkmConstants.ICON_YES_BUTTON + GeneralComunicator.i18nExtension("button.accept"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
				execute();
				hide();
	...
	public void langRefresh() {
		...
		cancelButton.setHTML(OkmConstants.ICON_NO_BUTTON + GeneralComunicator.i18nExtension("button.cancel"));
		acceptButton.setHTML(OkmConstants.ICON_YES_BUTTON + GeneralComunicator.i18nExtension("button.accept"));
	}
