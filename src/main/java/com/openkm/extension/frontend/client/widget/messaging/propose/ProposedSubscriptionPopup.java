...
public class ProposedSubscriptionPopup extends DialogBox {
	...
	public ProposedSubscriptionPopup() {
		...
		setText(GeneralComunicator.i18nExtension("propose.subscription.title"));
		users = "";
		roles = "";
		...
		errorNotify = new HTML(GeneralComunicator.i18nExtension("mesaging.label.must.select.users"));
		...
		closeButton = new Button(OkmConstants.ICON_NO_BUTTON + GeneralComunicator.i18nExtension("button.close"), new ClickHandler() {
			@Override
		...
		sendButton = new Button(OkmConstants.ICON_YES_BUTTON + GeneralComunicator.i18nExtension("button.send"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
		...
		sendButton.addStyleName("btn-success");
	...
	public void langRefresh() {
		setText(GeneralComunicator.i18nExtension("propose.subscription.title"));
		closeButton.setHTML(OkmConstants.ICON_NO_BUTTON + GeneralComunicator.i18nExtension("button.close"));
		sendButton.setHTML(OkmConstants.ICON_YES_BUTTON + GeneralComunicator.i18nExtension("button.send"));
		commentTXT = new HTML("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + GeneralComunicator.i18nExtension("messaging.label.notify.comment"));
	...
	private void sendProposal() {
		proposedSubscriptionService.send(uuid, type, users, roles, message.getText(), new AsyncCallback<Object>() {
			@Override
