...
public class FindFolderSelectPopup extends DialogBox {
	...
	public FindFolderSelectPopup() {
		...
		actionButton = new Button(OkmConstants.ICON_YES_BUTTON + GeneralComunicator.i18nExtension("htmleditor.add.link"), new ClickHandler() {
			@Override
			public void onClick(ClickEvent event) {
	...
	public void langRefresh() {
		...
		actionButton.setHTML(OkmConstants.ICON_YES_BUTTON + GeneralComunicator.i18nExtension("htmleditor.add.link"));
	}
