                ...
                <tr class="header">
                    <td align="right" colspan="9">
                        <form action="ActivityLog">
                            <b>From</b> <input type="text" name="dbegin" id="dbegin" value="${dbeginFilter}" size="15"
                                               readonly="readonly"/>
                            <b>To</b> <input type="text" name="dend" id="dend" value="${dendFilter}" size="15"
                                             readonly="readonly"/>
                            <b>User</b>
                            ...
                            <b style="padding-left: 14px;">Action</b>
                            ...
                            <b style="padding-left: 14px;">Item</b> <input type="text" name="item" id="item"
                                                                           value="${itemFilter}" size="42"
                                                                           style="vertical-align: middle;"/>
                            <input type="button" value="Reset" style="padding-left: 14px;"
