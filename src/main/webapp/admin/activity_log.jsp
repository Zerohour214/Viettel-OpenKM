			...
			<tr class="header">
	           <td align="right" colspan="9">
	              ...
	              <select name="action" id="action" style="width: 350px" data-placeholder="&nbsp;">
	                ...
	                <b style="padding-left: 14px;">Item</b> <input type="text" name="item" id="item" value="${itemFilter}" size="42" style="vertical-align: middle;" />
	                <input type="button" value="Reset"  style="padding-left: 14px;" class="resetButton btn btn-danger" id="resetButton"/>
