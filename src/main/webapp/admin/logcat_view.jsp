  ...
  <c:choose>
    <c:when test="${isAdmin}">
      ...
      <form action="LogCat">
        ...
        <table class="form form-logcat-renew">
          ...
          <tr><td colspan="2" align="right"><input class="btn btn-success" type="submit" value="Send"/></td></tr>
        </table>
      </form>
      <br/>
      <div style="width: 95%; margin-left: auto; margin-right: auto;">
        <table id="results" class="results table-stats-renew" style = "border-top: 1px solid #E5E5E9;">
          <thead>            
            <tr>
              <th width="2%">Line</th>
