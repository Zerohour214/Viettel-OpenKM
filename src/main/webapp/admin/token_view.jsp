            ...
            <tr class="${row.index % 2 == 0 ? 'even' : 'odd'}">
              ...
              <td style="padding-left: 20px;">
                <c:if test="${!token.suspended}">
                  <a href="${urlTokenSignal}"><span class="glyphicons glyphicons-electricity" style="font-size: 15px; color: #27B45F;" title="Signal"></span>
                  </a>
                </c:if>
              </td>
            </tr>
            ...
            <tr class="${row.index % 2 == 0 ? 'even' : 'odd'}">
              ...
              <td style="padding-left: 20px;">
                <c:if test="${!token.suspended && token.node != node}">
                  <a href="${urlTokenSetNode}">
                    <span class="glyphicons glyphicons-step-forward" style="font-size: 15px; color: #27B45F;" title="Move to this node"></span>
                  </a>
                </c:if>
              </td>
            </tr>
