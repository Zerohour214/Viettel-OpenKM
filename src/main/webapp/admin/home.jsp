...
<head>
  ...
  <link rel="stylesheet" href="../renew/css/layout-admin.css" type="text/css" />
  <title>Main</title>
</head>
<body>
  ...
  <c:choose>
    <c:when test="${isAdmin}">
      ...
      <br/>
      <table width="234px" class="form" style="margin-top: 25px; border: solid 1px #E5E5E9; background: #F3F6F9;">
