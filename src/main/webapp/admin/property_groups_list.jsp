      ...
      <ul id="breadcrumb">
        ...
        <li class="action">
          <a href="PropertyGroups?action=register"> 
            <span class="glyphicons glyphicons-cogwheel" style="padding: 2px 0px 0 0; font-size: 12px; color: #27B45F" title="Generic"></span> Register metadata groups
          </a>
        </li>
        <li class="action">
          <a href="PropertyGroups?action=edit"> 
            <span class="glyphicons glyphicons-cogwheel" style="padding: 2px 0px 0 0; font-size: 12px; color: #27B45F" title="Generic"></span> Edit metadata groups
          </a>
        </li>
      </ul>
