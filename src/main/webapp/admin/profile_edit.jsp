  ...
  <c:choose>
    <c:when test="${isAdmin}">
      ...
      <form action="Profile">
        ...
        <table width="770px" border="0" style="margin-left: auto; margin-right: auto; margin-bottom: -3px;">
          <tr>
            <td>
              <ul class='tabs'>
          ...
          <table class="form" width="765px" border="0">
            ...
            <td colspan="2" align="right">
              ...
              <c:choose>
                ...
                <c:when test="${action == 'clone'}"><input type="submit" value="Clone" class="yesButton btn btn-success"/></c:when>
              </c:choose>
            </td>
          </tr>
          </table>
