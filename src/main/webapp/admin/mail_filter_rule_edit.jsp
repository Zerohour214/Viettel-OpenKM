        ...
        <table class="form" width="345px" align="center">
          ...
          <tr>
            <td colspan="2" align="right">
              ...
              <c:choose>
                <c:when test="${action == 'ruleCreate'}"><input type="submit" value="Create" class="yesButton btn btn-success"/></c:when>
                <c:when test="${action == 'ruleEdit'}"><input type="submit" value="Edit" class="yesButton btn btn-success"/></c:when>
                <c:when test="${action == 'ruleDelete'}"><input type="submit" value="Delete" class="yesButton btn btn-success"/></c:when>
              </c:choose>
            </td>
          </tr>
        </table>
