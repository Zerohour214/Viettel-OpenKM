    ...
    <c:when test="${isAdmin}">
      ...
      <form action="CheckTextExtraction" method="post" enctype="multipart/form-data">
        <table class="form" align="center">
          ...
          <tr>
            ...
            <td><a class="ds" href="../extension/DataBrowser?action=repo&sel=doc&dst=repoPath&path=<u:getParent path="${repoPath}"/>"><span class="glyphicons glyphicons-folder-open" style="font-size: 12px; color: #27B45F"></span></a></td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="3" align="right">
              ...
              <input type="submit" value="Check" class="yesButton btn btn-success"/>
            </td>
          </tr>
        </table>
      </form>
      ...
      <c:if test="${not empty mimeType}">
        ...
        <div style="width: 80%; margin-left: auto; margin-right: auto;">
          <table id="results" class="results data-table-has-footer-renew">
            <thead>
              <tr>
