       ...
       <table class="form" width="250px">
         ...
         <tr>
           <td colspan="2" align="right">
             ...
             <c:choose>
                <c:when test="${action == 'groupCreate'}"><input type="submit" value="Create" class="yesButton btn btn-success"/></c:when>
                <c:when test="${action == 'groupEdit'}"><input type="submit" value="Edit" class="yesButton btn btn-success"/></c:when>
                <c:when test="${action == 'groupDelete'}"><input type="submit" value="Delete" class="yesButton btn btn-success"/></c:when>
              </c:choose>
           </td>
         </tr>
       </table>
