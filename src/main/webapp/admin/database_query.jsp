...
<head>
  ...
  <style type="text/css">
    .CodeMirror { width: 700px; height: 300px; }
                ...
                <table>
                  ...
                  <tr>
                    ...
                    <td align="right">
                      ...
                      <input type="submit" value="Execute" class="executeButton btn btn-success" />
                    </td>
                  </tr>
                </table>
              </form>
              ...
              <form action="DatabaseQuery" method="post" enctype="multipart/form-data">
                ...
                <table>
                  <tr>
                    ...
                    <td><input type="submit" value="Import SQL script" class="loadButton btn btn-success" /></td>
                  </tr>
                </table>
              </form>
            </td>
