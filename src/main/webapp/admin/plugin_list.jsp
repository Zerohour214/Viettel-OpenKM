              ...
              <tr class="${row.index % 2 == 0 ? 'even' : 'odd'}">
                ...
                <td align="center">
                  <c:if test="${plugin.isLoaded()}">
                    ...
                    <c:choose>
                      <c:when test="${found}">
                        <a href="${url}"><span class="glyphicons glyphicons-ok" style="font-size: 15px; color: #27B45F" title="Active"></span></a>
                      </c:when>
                      <c:otherwise>
                        <a href="${url}"><span class="glyphicons glyphicons-remove" style="font-size: 15px; color: red" title="Inactive"></span> </a>
                      </c:otherwise>
                    </c:choose>
                  </c:if>
                </td>
