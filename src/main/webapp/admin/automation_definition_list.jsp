      ...
      <table class="results-old" width="70%">
              ...
              <table id="info" style="white-space: nowrap;" width="175px">
                <tr>
                  ...
                  <td width="100%" align="right">
                    <a id="show_hide" href="#"><span class="glyphicons glyphicons-search" style="font-size: 15px; color: #27B45F" title="Show / Hide"></span></a>
                  </td>
                </tr>
                <tr>
                  <td>
            ...
            <c:if test="${action ne 'viewDefinition'}">
              <table>
                <tr>
                  ...
                  <td>
                    <span id="addValidation" class="glyphicons glyphicons-plus-sign" style="cursor:pointer; cursor:hand; font-size: 15px; color: #27B45F" title="New validation"></span>
                  </td>
                </tr>
              </table>
            </c:if>
        ...
        <c:forEach var="validation" items="${ar.validations}" varStatus="row">
          ...
          <tr class="${row.index % 2 == 0 ? 'even' : 'odd'}">
            ...
            <td align="center">
              <c:if test="${action ne 'viewDefinition'}">
                <a href="javascript:editValidation('${validation.className}', '${validation.id}')"><span class="glyphicons glyphicons-pen" style="font-size: 15px; color: #27B45F;" title="Edit"></span></a>
                &nbsp;
                <a href="javascript:deleteValidation('${validation.className}', '${validation.id}')"><span class="glyphicons glyphicons-bin" style="font-size: 15px; color: red;" title="Delete"></span></a>
              </c:if>
            </td>
          </tr>
        </c:forEach>
            ...
            <c:if test="${action ne 'viewDefinition'}">
              <table>
                <tr>
                  ...
                  <td>
                    <span id="addAction" class="glyphicons glyphicons-plus-sign" style="cursor:pointer; cursor:hand; font-size: 15px; color: #27B45F" title="New action"></span>
                  </td>
                </tr>
              </table>
            </c:if>
        ...
        <c:forEach var="action" items="${ar.actions}" varStatus="row">
          ...
          <tr class="${row.index % 2 == 0 ? 'even' : 'odd'}">
            ...
            <td align="center">
              <c:if test="${action ne 'viewDefinition'}">
                <a href="javascript:editAction('${action.className}', '${action.id}')"><span class="glyphicons glyphicons-pen" style="font-size: 15px; color: #27B45F;" title="Edit"></span></a>
                &nbsp;
                <a href="javascript:deleteAction('${action.className}', '${action.id}')"><span class="glyphicons glyphicons-bin" style="font-size: 15px; color: red;" title="Delete"></span></a>
              </c:if>
            </td>
          </tr>
        </c:forEach>
