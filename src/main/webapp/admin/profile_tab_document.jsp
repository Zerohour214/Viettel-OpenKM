...
<fieldset>
  ...
  <table>
    ...
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.prfTab.prfDocument.relatedVisible}">
            <input name="prf_tab_document_related_visible" type="checkbox" checked="checked"/>
          </c:when>
          <c:otherwise>
            <input name="prf_tab_document_related_visible" type="checkbox"/>
          </c:otherwise>
        </c:choose>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <c:choose>
          <c:when test="${prf.prfTab.prfDocument.activityVisible}">
            <input name="prf_tab_document_activity_visible" type="checkbox" checked="checked"/>
          </c:when>
          <c:otherwise>
            <input name="prf_tab_document_activity_visible" type="checkbox"/>
          </c:otherwise>
        </c:choose>
      </td>
    </tr>
