...
<head>
  ...
  <link rel="stylesheet" href="../renew/css/layout.css" type="text/css"/>
  <link rel="stylesheet" href="../renew/fonts/glyphicons/glyphicons.css" type="text/css"/>
  ...
  <style type="text/css">
    ...
    div#menu { border-bottom: 1px solid #E5E5E9; background-color: #F3F6F9;}
  </style>
...
%>
  ...
  <c:choose>
    <c:when test="${isAdmin}">
	  ...
	  <div><iframe id="frame" name="frame" src="" frameborder="0"></iframe></div>
    </c:when>
    <c:otherwise>
