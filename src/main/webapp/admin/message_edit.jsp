      ...
      <form action="LoggedUsers">
        ...
        <tr>
          <td colspan="2" align="right">
            ...
            <c:choose>
                <c:when test="${action == 'messageCreate'}"><input type="submit" value="Create" class="yesButton btn btn-success"/></c:when>
                <c:when test="${action == 'messageEdit'}"><input type="submit" value="Edit" class="yesButton btn btn-success"/></c:when>
                <c:when test="${action == 'messageDelete'}"><input type="submit" value="Delete" class="yesButton btn btn-success"/></c:when>
              </c:choose>
          </td>
        </tr>
        </table>
