...
<head>
    ...
    <meta
        content="OpenKM is an EDRMS EDRMS, Document Management System and Record Management, easily to manage digital content, simplify your workload and yield high efficiency."
        name="description">
...
<div id="openkmNews" class="openkm-news">
    <div id="openkmVersion" class="openkm-version">
        ...
        <div id="stickerController" class="openkm-sticker" style="display:none;">
            <a href="#" id="backward" style="cursor:hand !important;"><img src="img/backward.png" alt="Backward"
                                                                           title="Backward"/></a>
            <a href="#" id="stop" style="cursor:hand !important;"><img id="stopImg" src="img/stop.png" alt="Stop"
                                                                       title="Stop"/></a>
            <a href="#" id="forward" style="cursor:hand !important;"><img src="img/forward.png" alt="Forward"
                                                                          title="Forward"/></a>
            <a href="#" id="eye" style="cursor:hand !important;"><img id="eyeImg" src="img/eye.png"
                                                                      alt="Show / hide news" title="Show / hide news"/></a>
        </div>
    </div>
        ...
        <form name="loginform" method="post" action="j_spring_security_check" onsubmit="setCookie()"
            ...
            <div class="form-group">
                <div class="col-xs-12">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-asterisk"></i></span>
                        <input type="hidden" name="loggin_normal" class="form-control input-lg"
                               value="1">
                    </div>
                </div>
            </div>
            <div class="form-group form-actions">
                ...
                <div class="col-xs-4 pull-right">
                    <button name="submit" type="submit" class="btn btn-sm btn-primary btn-block"><i
                        class="fa fa-key"></i> Login
                    </button>
                    <button id ="btnSSO" name="submitSSO" onClick="loginSSO('<%=KmConnector.getSSOLink()%>')" class="btn btn-sm btn-primary btn-block"><i class="fa fa-key"></i> Login by SSO
                    </button>
                </div>
            </div>
            ...
            <div class="form-group form-footer"
                ...
                <div class="col-xs-12 text-center">
                    <p>&copy; 2006-2018 Knowledge. All rights reserved.</p>
                </div>
            </div>
        </form>
    </div>
...
<script type="text/javascript">
    ...
    const btnSSO = document.querySelector('#btnSSO');
    btnSSO.addEventListener('click', handleSubmit);
